 ...
 *
 * Each entry is a key/value pair that lands in the packaged Slick.app's
 ...
 * "Slick wants to access Music" prompt unless the Info.plist disclaims it
 ...
 * user ("Slick wants to access Music" when Slick never touches the Music
