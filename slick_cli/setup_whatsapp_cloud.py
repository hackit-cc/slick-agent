...
Entry point: ``slick whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``slick_cli/main.py``).
...
Slick gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Slick to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Slick needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Slick gateway in another terminal:")
    print("         slick gateway")
    print()
    ...
    print()
    print("  Docs: https://slick-agent.sophostechne.com/docs/user-guide/")
