...
# _sophos_auth_status_cache). Falls back to a fresh load when the file cannot
# be stat'ed.
...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("subscription", "View your Sophos plan and change it in the browser", "Info",
               cli_only=True, aliases=("upgrade",)),
    CommandDef("topup", "Show your Sophos balance and manage billing on the portal", "Info"),
...
class SlashCommandCompleter(Completer):
    ...
    def _personality_completions(sub_text: str, sub_lower: str):
        ...
        try:
            ...
            # freshness-correct (same pattern as load_env / _sophos_auth_status_cache).
