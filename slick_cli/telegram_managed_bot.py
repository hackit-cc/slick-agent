...
manual BotFather token copy-paste. Slick talks only to the Hackit onboarding
...
# Default pairing API base URL (Hackit-hosted Cloudflare Worker).
# Override for PoC/staging with TELEGRAM_ONBOARDING_URL.
DEFAULT_API_URL = "https://setup.slick-agent.hackit.cc"
TELEGRAM_ONBOARDING_URL_ENV = "TELEGRAM_ONBOARDING_URL"

# The Hackit-hosted manager bot username (without @). The backend returns the
