...
def build_gateway_parser(
    ...
    gateway_enroll = gateway_subparsers.add_parser(
        ...
        description=(
            ...
            "Authenticates as your Hackit Portal account (the connector derives the "
    ...
    proxy_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "to an OAuth-authenticated provider (e.g. Hackit Portal). External "
    ...
    proxy_start.add_argument(
        "--provider",
        default="hackit",
        help="Upstream provider: hackit or xai (default: hackit). See `slick proxy providers`.",
    )
    proxy_start.add_argument(
        "--host",
        default=None,
