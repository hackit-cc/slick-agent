...
Examples:
    ...
    slick debug share --sophos       Upload to Sophos-internal storage (private)
...
""",
    ...
    share_parser.add_argument(
        ...
        action="store_true",
        help=(
            "Upload the debug bundle to Sophos-internal storage (AWS S3) instead "
            "of a public paste service. The bundle is private — viewable only "
            "by Sophos staff (and allowlisted Discord mods) via a Google-login-"
