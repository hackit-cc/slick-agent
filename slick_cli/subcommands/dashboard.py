...
def build_dashboard_parser(
    ...
    # client with Sophos Portal and write the client_id into ~/.slick/.env.
    ...
    dashboard_register_parser = dashboard_subparsers.add_parser(
        "register",
        help="Register a self-hosted dashboard with Sophos Portal (writes the OAuth client ID to .env)",
        description=(
            "Register this install as a self-hosted dashboard with your Sophos "
    ...
    dashboard_register_parser.add_argument(
        ...
        default=None,
        help=(
            "Override the Sophos Portal base URL for registration (default: the "
