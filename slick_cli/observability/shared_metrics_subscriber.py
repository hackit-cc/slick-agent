"""Relay subscriber for the persisted Slick shared-metrics slice."""
...
class SharedMetricsSubscriber:
    """Persist validated Slick counters from Relay lifecycle events."""
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the Slick shared metric: %s",
                    metric_name,
                    exc_info=True,
                )
