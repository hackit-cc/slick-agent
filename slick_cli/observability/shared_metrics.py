"""Durable aggregation and local export for Slick shared metrics."""
...
from slick_cli.sqlite_util import write_txn
...
_PACKAGE_SCHEMA_VERSION = "slick.shared_metrics.v2"
...
class SharedMetricsStore:
    ...
    def __init__(
        ...
        root = get_slick_home() / "telemetry" / "shared_metrics"
        ...
        return [
            {
                ...
                "resource": {
                    "slick_version": row["slick_version"],
    ...
    def _ensure_schema(self) -> None:
        with self._connection(busy_timeout_ms=_SCHEMA_BUSY_TIMEOUT_MS) as connection:
            # Serialize first-run creation and upgrades across Slick processes.
            with write_txn(connection):
    ...
    def _create_package_in_transaction(
        ...
        resource = {
            "slick_version": period_row["slick_version"],
