"""
Slick CLI - Unified command-line interface for Slick Agent.

Provides subcommands for:
- slick chat          - Interactive chat (same as ./slick)
- slick gateway       - Run gateway in foreground
- slick gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `slick setup` on a fresh Pi.
    ...
    slick_cli/stdio.py::configure_windows_stdio() runs later from the entry
