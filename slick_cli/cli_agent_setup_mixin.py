...
class CLIAgentSetupMixin:
    ...
    def _offer_first_run_setup(self) -> bool:
        ...
        exact same flow as ``slick model`` (which fronts Quick Setup / Hackit
        ...
        _cprint("  You'll pick a provider (Hackit Portal OAuth is the fastest; "
    ...
    def _init_agent(self, *, model_override: str = None, runtime_override: dict = None, request_overrides: dict | None = None) -> bool:
        ...
        try:
            ...
            # + fail-open inside the helper; harmless for non-Hackit providers.
            try:
