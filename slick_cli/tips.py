...
TIPS = [
    ...
    # --- MCP ---
    "slick mcp opens an interactive picker of Sophos-approved MCPs you can install in one keystroke.",
    "slick mcp catalog lists Sophos-approved MCP servers shipped with the repo.",
    ...
    "slick auth add sophos or slick auth add openai-codex sets up OAuth-based providers.",
    ...
    "Skills from trusted repos (SophosTechne) get a 'trusted' security level; community skills get extra scanning.",
    ...
    'use_gateway: true per-tool routes web, image, tts, or browser through your Sophos subscription — no extra keys.',
