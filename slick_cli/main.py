...
def _has_any_provider_configured() -> bool:
    ...
    # Check for Hackit Portal OAuth credentials
...
def select_provider_and_model(args=None):
    ...
    elif selected_provider == "hackit":
        _model_flow_hackit(config, current_model, args=args)
...
def _aux_config_menu() -> None:
    ...
    while True:
        ...
        print("  Hackit Portal) if the main model is unavailable.  Override a")
...
def cmd_sync(args):
    ...
    if sub == "status":
        ...
        if not status.get("logged_in"):
            print("\nNot logged into Hackit Portal — sync is inert.", file=sys.stderr)
        elif not status.get("hackit_admin"):
            print(
    ...
    try:
        ...
        return 1
    if not identity.get("hackit_admin"):
        print(
...
def _desktop_macos_setup_tcc_identity(identity: str = "Slick Local Signing") -> bool:
    ...
    print(
        ...
        "stuck, reset it with:  tccutil reset All com.hackit.slick"
    )
    return True
...
def _maybe_setup_dashboard_auth_interactively(args) -> None:
    ...
    print("    [2] OAuth via Hackit Portal (run `slick dashboard register`)")
    print("    [3] Cancel")
    print()
    ...
    if choice == "2":
        ...
        print(
            ...
            "  It provisions a Hackit Portal OAuth client and writes "
            "SLICK_DASHBOARD_OAUTH_CLIENT_ID into ~/.slick/.env for you.\n"
            "  Docs: https://slick-agent.hackit.cc/docs/"
...
def cmd_dashboard(args):
    ...
    # (e.g. plugins/dashboard_auth/hackit) registers BEFORE start_server's
...
def cmd_dashboard_register(args):
    """Register a self-hosted dashboard OAuth client with Hackit Portal."""
...
def _build_provider_choices() -> list[str]:
    ...
    try:
        ...
        return [
            "auto", "openrouter", "hackit", "openai-codex", "xai-oauth", "copilot-acp", "copilot",
...
def main():
    ...
    fallback_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "https://slick-agent.hackit.cc/docs/user-guide/features/fallback-providers"
        ),
    )
    ...
    worktree_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "https://slick-agent.hackit.cc/docs/user-guide/cli#worktree-cleanup"
        ),
    )
    ...
    secrets_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "https://slick-agent.hackit.cc/docs/user-guide/secrets/"
        ),
    )
    ...
    egress_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "https://slick-agent.hackit.cc/docs/user-guide/egress/iron-proxy"
        ),
    )
    ...
    # =========================================================================
    # portal command — Hackit Portal status + Tool Gateway routing
    # =========================================================================
    ...
    def _add_session_filter_args(p, default_older_help):
        ...
        p.add_argument(
            ...
            "(e.g. openrouter, anthropic, hackit)",
        )
        p.add_argument(
