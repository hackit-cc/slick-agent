...
def _print_curator_first_run_notice() -> None:
    ...
    print(
        "  Docs:         https://slick-agent.hackit.cc/docs/user-guide/features/curator"
    )
...
def _update_via_zip(args, *, had_desktop_app_before_update: bool = False) -> bool:
    ...
    zip_url = (
        f"https://github.com/hackit-cc/slick-agent/archive/refs/heads/{branch}.zip"
    )
    ...
    try:
        ...
        print(
            ...
            "reinstall from https://slick-agent.hackit.cc"
        )
        _m().sys.exit(1)
    finally:
...
OFFICIAL_REPO_URLS = {
    "https://github.com/hackit-cc/slick-agent.git",
    "git@github.com:Hackit/slick-agent.git",
    "https://github.com/hackit-cc/slick-agent",
    "git@github.com:Hackit/slick-agent",
}

OFFICIAL_REPO_URL = "https://github.com/hackit-cc/slick-agent.git"
...
def _sync_with_upstream_if_needed(
    ...
    *,
    ...
    if not has_upstream:
        ...
        print("  This means you may miss updates from Hackit/slick-agent.")
        print()
        ...
        if assume_yes or (
            ...
            print(
                "  Add it later with: git remote add upstream https://github.com/hackit-cc/slick-agent.git"
            )
            return False
        ...
        if response in {"", "y", "yes"}:
            ...
            if _add_upstream_remote(git_cmd, cwd):
                print(
                    "  ✓ Added upstream: https://github.com/hackit-cc/slick-agent.git"
                )
                has_upstream = True
            else:
            ...
            print(
                "  Skipped. Run 'git remote add upstream https://github.com/hackit-cc/slick-agent.git' to add later."
            )
...
def _cmd_update_impl(args, gateway_mode: bool):
    ...
    try:
        ...
        if not import_ok:
            ...
            print("    https://slick-agent.hackit.cc")
        ...
        if sys.platform == "darwin" and had_desktop_app_before_update:
            ...
            print(
                ...
                "`tccutil reset ScreenCapture com.hackit.slick` (repeat "
