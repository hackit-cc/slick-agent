...
Invoked by ``slick kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Slick Agent board.
...
def _profile_author() -> str:
    """Mirror of ``slick_cli.kanban._profile_author``."""
    return (
