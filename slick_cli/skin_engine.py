"""Slick skin/theme engine — the theme SDK for every surface.

A data-driven skin system that lets users (and Slick itself) customize the
visual appearance across the CLI, the TUI, and the desktop GUI from a single
file. Skins are defined as YAML files in ~/.slick/skins/ or as built-in presets.
...
``resolve_skin`` / ``skin.changed``). A skin dropped in ~/.slick/skins/ therefore
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Slick Agent"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! 😎"              # Shown on exit
      response_label: " 😎 Slick "       # Response box header label
...
.. code-block:: python
    ...
    from slick_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "Slick Agent"

    set_active_skin("ruby")               # Switch to built-in ruby skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.slick/skins/
...
Drop a YAML file in ``~/.slick/skins/<name>.yaml`` following the schema above.
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces SLICK_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces SLICK_SMILY)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic Slick — gold and kawaii",
        # Dark-authored. Values match the TUI's DARK_THEME so the classic CLI
        # and the TUI render the same Slick gold.
        "colors": {
        ...
        "branding": {
            "agent_name": "Slick Agent",
            "welcome": "Welcome to Slick Agent! Type your message or /help for commands.",
            "goodbye": "Goodbye! 😎",
            "response_label": " 😎 Slick ",
            "prompt_symbol": "❯",
    ...
    "ruby": {
        "name": "ruby",
        "description": "Crimson and bronze",
        "colors": {
        ...
        "branding": {
            ...
            "welcome": "Welcome to Ruby Agent! Type your message or /help for commands.",
    ...
    "mint": {
        ...
        "spinner": {
            ...
            "thinking_verbs": [
                ...
                "steering the helm", "tracking undertow", "plotting sea lanes",
        ...
        "branding": {
            "agent_name": "Mint Agent",
            "welcome": "Welcome to Mint Agent! Type your message or /help for commands.",
            "goodbye": "Fair winds! Ψ",
            "response_label": " Ψ Mint ",
            "prompt_symbol": "Ψ",
...
[dim #153C73]⠀⠀⠀⠀⠀⠀⠀deep waters hold⠀⠀⠀⠀⠀⠀⠀[/]""",
    ...
    "refactor": {
        "name": "refactor",
        "description": "Austere grayscale with persistence",
        "colors": {
        ...
        "spinner": {
            ...
            "thinking_faces": ["(◉)", "(◬)", "(◌)", "(○)", "(●)"],
            "thinking_verbs": [
                "finding traction", "measuring the diff", "resetting the branch",
                "counting the ascent", "testing leverage", "setting the shoulder",
                "pushing upstream", "enduring the loop",
            ],
            "wings": [
                ["⟪◉", "◉⟫"],
                ["⟪◬", "◬⟫"],
        ...
        "branding": {
            ...
            "welcome": "Welcome to Refactor Agent! Type your message or /help for commands.",
            "goodbye": "The backlog waits. ◉",
            "response_label": " ◉ Refactor ",
            "prompt_symbol": "◉",
            "help_header": "(◉) Available Commands",
        },
        "tool_prefix": "│",
