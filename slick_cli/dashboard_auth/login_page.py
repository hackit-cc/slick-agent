...
Visual styling mirrors the Sophos Techne design system (the
``@sophostechne/ui`` package the React dashboard uses): the same
...
<style>
  /* Brand fonts shipped by @sophostechne/ui — same files the SPA loads. */
  @font-face {{
...
<body>
<main>
  <div class="brand">Sophos<span class="dot"></span>Research</div>
  <div class="card">
    <h1>Sign in</h1>
...
See the <a href="https://slick-agent.sophostechne.com/docs/user-guide/features/web-dashboard#authentication-gated-mode">dashboard
