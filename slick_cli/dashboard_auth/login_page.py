...
Visual styling mirrors the Hackit design system (the
``@hackit/ui`` package the React dashboard uses): the same
``Google Sans Flex`` / ``Rules Compressed`` typeface, amber-on-dark colour
...
``tests/slick_cli/test_dashboard_auth_401_reauth.py``.
"""
...
<title>Sign in — Slick Agent</title>
<style>
  /* Brand fonts shipped by @hackit/ui — same files the SPA loads. */
  @font-face {{
  ...
  *, *::before, *::after {{ box-sizing: border-box; }}
  ...
  .brand {{
    ...
    font-family: 'Rules Compressed', 'Google Sans Flex', sans-serif;
    font-weight: 600;
    font-size: 1.05rem;
...
<body>
<main>
  <div class="brand">Hackit<span class="dot"></span>Research</div>
  <div class="card">
    <h1>Sign in</h1>
    <p class="subtitle">Choose a sign-in method to continue to the Slick Agent dashboard.</p>
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Sign-in unavailable — Slick Agent</title>
<style>
  @font-face {
    font-family: 'Google Sans Flex';
    font-style: normal;
...
See the <a href="https://slick-agent.hackit.cc/docs/user-guide/features/web-dashboard#authentication-gated-mode">dashboard
