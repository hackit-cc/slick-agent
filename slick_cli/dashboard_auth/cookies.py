...
Three cookies in play:
  ...
  - slick_session_rt:   the OAuth refresh token
                         ...
                         Sophos Portal issues a rotating refresh token for the
...
# auth plugins are enabled (for example Basic + Sophos OAuth).
...
def set_session_cookies(
    ...
    *,
    ...
    ``refresh_token`` is written as the RT cookie when non-empty. Sophos Portal
