...
- Use the **semantic text tokens** from `@hackit/ui`'s `globals.css`:
...
- The dashboard preserves the Hackit brand uppercase aesthetic, but it is **opt-in per element, not global**.
