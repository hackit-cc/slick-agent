...
const STORAGE_KEY = "slick-dashboard-theme";
...
const FONT_STORAGE_KEY = "slick-dashboard-font";
...
const THEME_NAME_ALIASES: Record<string, string> = {
  // Renamed during the LENS_5I port + Sophos-blue rebrand.
  "lens-5i": "sophos-blue",
};
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `slick_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "slick-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-slick-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-slick-theme-font", "true");
...
function applyTheme(theme: DashboardTheme) {
  ...
  // (e.g. Sophos Blue) doesn't leave its values behind when the user
