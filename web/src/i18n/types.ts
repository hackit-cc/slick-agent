...
export interface Translations {
  ...
  status: {
    ...
    stopped: string;
    updateSlick: string;
    updateSlickConfirmMessage?: string;
    updateSlickConfirmNow?: string;
    updateSlickConfirmTitle?: string;
    updatingSlick: string;
  ...
  // ── Achievements plugin (plugins/slick-achievements) ──
  achievements: {
    hero: {
      kicker: string;
      title: string;
