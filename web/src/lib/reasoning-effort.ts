 ...
 *
 * Values mirror slick_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the Slick default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (Slick' default when unset). */
