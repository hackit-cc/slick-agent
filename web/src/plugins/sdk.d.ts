 ...
 *      (``@/lib/api``, ``@hackit/ui``, …). Deriving the type would
 ...
 *     (pulls @hackit/ui types into the contract) or is the loose
...
export interface SlickPluginSDK {
  ...
  /**
   * Shared UI primitives (Hackit DS / shadcn). Typed permissively at the
