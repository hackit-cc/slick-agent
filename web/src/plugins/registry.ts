 ...
 *
 * Plugins call window.__SLICK_PLUGINS__.register(name, Component)
...
} from "@sophostechne/ui/ui/components/dialog";
...
import { Card, CardHeader, CardTitle, CardContent } from "@sophostechne/ui/ui/components/card";
import { Input } from "@sophostechne/ui/ui/components/input";
import { Label } from "@sophostechne/ui/ui/components/label";
import { Separator } from "@sophostechne/ui/ui/components/separator";
import { Tabs, TabsList, TabsTrigger } from "@sophostechne/ui/ui/components/tabs";
 ...
 * Exposed at runtime as ``window.__SLICK_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__SLICK_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__SLICK_PLUGIN_SDK__ = {
    ...
    // window.__SLICK_SESSION_TOKEN__ directly.
    authedFetch,
    ...
    // UI components — Sophos DS where available, shadcn/ui primitives elsewhere.
    components: {
      Card,
      CardHeader,
      CardTitle,
