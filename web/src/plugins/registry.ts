...
} from "@hackit/ui/ui/components/dialog";
...
import { Card, CardHeader, CardTitle, CardContent } from "@hackit/ui/ui/components/card";
import { Input } from "@hackit/ui/ui/components/input";
import { Label } from "@hackit/ui/ui/components/label";
import { Separator } from "@hackit/ui/ui/components/separator";
import { Tabs, TabsList, TabsTrigger } from "@hackit/ui/ui/components/tabs";
...
export function exposePluginSDK() {
  ...
  window.__SLICK_PLUGIN_SDK__ = {
    ...
    // UI components — Hackit DS where available, shadcn/ui primitives elsewhere.
    components: {
      Card,
      CardHeader,
      CardTitle,
