...
import { ListItem } from "@sophostechne/ui/ui/components/list-item";
import { Segmented } from "@sophostechne/ui/ui/components/segmented";
...
const SOURCE_CONFIG: Record<string, { icon: typeof Terminal; color: string }> =
  {
    ...
    slick_flow: { icon: Play, color: "text-warning" },
...
const NO_MATCHING_SESSION_SOURCE = "__slick_dashboard_no_matching_source__";
        ...
        const res = await fetch(api.exportSessionUrl(id), {
          ...
          headers: {
            "X-Slick-Session-Token":
              (window as unknown as { __SLICK_SESSION_TOKEN__?: string })
                .__SLICK_SESSION_TOKEN__ ?? "",
          },
        });
