...
import { Badge } from "@hackit/ui/ui/components/badge";
import { Button } from "@hackit/ui/ui/components/button";
import { Spinner } from "@hackit/ui/ui/components/spinner";
import { H2 } from "@hackit/ui/ui/components/typography/h2";
import { Card, CardContent } from "@hackit/ui/ui/components/card";
import { Checkbox } from "@hackit/ui/ui/components/checkbox";
import { Input } from "@hackit/ui/ui/components/input";
import { Label } from "@hackit/ui/ui/components/label";
import { Select, SelectOption } from "@hackit/ui/ui/components/select";
import { Toast } from "@hackit/ui/ui/components/toast";
import { useToast } from "@hackit/ui/hooks/use-toast";
import { useConfirmDelete } from "@hackit/ui/hooks/use-confirm-delete";
import { ConfirmDialog } from "@hackit/ui/ui/components/confirm-dialog";
...
export default function SystemPage() {
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <section className="flex flex-col gap-3">
        <H2 variant="sm" className="flex items-center gap-2 text-muted-foreground">
          <Globe className="h-4 w-4" /> Hackit Portal
        </H2>
        <Card>
          <CardContent className="flex flex-col gap-3 py-4">
            <div className="flex items-center gap-3">
              ...
              <a
                href={portal?.subscription_url || "https://portal.hackit.cc/manage-subscription"}
                target="_blank"
                rel="noreferrer"
