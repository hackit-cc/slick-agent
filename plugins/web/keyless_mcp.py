...
two endpoints so a fresh Slick install with **zero web credentials** still
...
def provider_tier(name: str) -> str:
    ...
    ``slick tools`` picker's Free/Paid rows). ``free`` forces the keyless
    ...
    try:
        ...
        return {
            ...
            "error": (
                ...
                "backend via `slick tools` for reliable service."
            ),
        }
    ...
    try:
        ...
        return {
            ...
            "error": (
                ...
                "via `slick tools` for reliable service."
            ),
        }
