...
Configuration
-------------
Secret (lives in $SLICK_HOME/.env or the environment):
...
Behavioral settings (live in $SLICK_HOME/mem0.json, set via `slick memory
setup`):
  ...
  agent_id           — Agent identifier (default: slick)
...
def _load_config() -> dict:
    """Load config from env vars, with $SLICK_HOME/mem0.json overrides.
    ...
    config = {
        ...
        "agent_id": os.environ.get("MEM0_AGENT_ID", "slick"),
        "oss": {},
    }
    ...
    config_path = get_slick_home() / "mem0.json"
...
class Mem0MemoryProvider(MemoryProvider):
    ...
    def save_config(self, values, slick_home):
        """Write config to $SLICK_HOME/mem0.json."""
        import json
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        #   1. Operator-configured MEM0_USER_ID (env or $SLICK_HOME/mem0.json) —
        ...
        self._agent_id = self._config.get("agent_id", "slick")
