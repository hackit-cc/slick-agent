...
# When the user hasn't picked a reasoning effort, Slick passes
...
# ON at this effort — matching the "medium (default)" that Slick' /reasoning
...
class UpstageProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        # Map Slick' effort vocabulary onto Solar's accepted set via the
