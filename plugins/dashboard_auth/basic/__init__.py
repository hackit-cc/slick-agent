...
into the same ``DashboardAuthProvider`` framework as the Hackit OAuth
...
mirroring the Hackit provider's precedence convention:
...
Skip reasons:
  Like the Hackit provider, this exposes a module-level ``LAST_SKIP_REASON``
