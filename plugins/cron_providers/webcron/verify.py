"""Inbound cron-fire token verification for Webcron (Phase 4E.1).
...
logger = logging.getLogger("cron.webcron.verify")
...
# fire. See docs/webcron-managed-cron-contract.md and the betterstack triage.
...
def _get_jwk_client(jwks_url: str) -> Any:
    ...
    with _JWK_CLIENTS_LOCK:
        ...
        if client is None:
            ...
            # (same fix as the dashboard-auth hackit/self_hosted providers).
            client = PyJWKClient(
                jwks_url,
                headers={
