...
(function () {
  ...
  const DOCS_URL = "https://slick-agent.hackit.cc/docs/user-guide/features/kanban";
  const DOCS_TUTORIAL_URL = "https://slick-agent.hackit.cc/docs/user-guide/features/kanban-tutorial";
