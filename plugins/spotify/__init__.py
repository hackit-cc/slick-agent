...
``_check_spotify_available()`` — when the user has not run ``slick auth
spotify``, the tools remain registered (so they appear in ``slick
...
The Spotify auth flow (``slick auth spotify``), CLI plumbing, and docs
