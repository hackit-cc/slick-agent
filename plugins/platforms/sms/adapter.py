...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> Slick gateway adapter.

    Each inbound phone number gets its own Slick session (multi-tenant).
...
# static dict in slick_cli/gateway.py, and the _send_sms dispatch in
