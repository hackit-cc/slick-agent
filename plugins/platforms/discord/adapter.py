...
def _format_privileged_intents_guidance(*, needs_members: bool) -> str:
    ...
    lines.extend(
        [
            ...
            "Docs: https://slick-agent.hackit.cc/docs/user-guide/messaging/discord",
        ]
    )
    return "\n".join(lines)
...
def _define_discord_view_classes() -> None:
    ...
    class ModelPickerView(discord.ui.View):
        ...
        def _build_model_select(self, provider_slug: str):
            ...
            truncating at 25. This matters for providers like Hackit whose
        ...
        async def _on_provider_selected(self, interaction: discord.Interaction):
            ...
            # and silently dropped the tail (e.g. Hackit `:free` Portal picks).
