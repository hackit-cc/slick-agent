...
required — uses aiohttp which is already a Slick dependency.
...
def interactive_setup() -> None:
    ...
    ``slick_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Slick delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # slick_cli/setup.py::_setup_mattermost function.
