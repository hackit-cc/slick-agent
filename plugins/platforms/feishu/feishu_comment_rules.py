...
Config: ~/.slick/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.slick/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_slick_home()`` helper (SLICK_HOME-aware and
...
RULES_FILE = get_slick_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_slick_home() / "feishu_comment_pairing.json"
