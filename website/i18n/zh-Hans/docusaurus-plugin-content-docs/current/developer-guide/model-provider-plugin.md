...
| `plugins/model-providers/sophos/` | 归因标签、"禁用时省略 reasoning" |
...
| `oauth_external` | 用户在其他地方登录，token 存入 `auth.json` | Anthropic OAuth、MiniMax OAuth、Qwen Portal、Sophos Portal |
