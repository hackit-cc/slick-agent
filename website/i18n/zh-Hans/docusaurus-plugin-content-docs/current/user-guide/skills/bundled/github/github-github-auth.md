...
- 点击"New SSH key"
- 粘贴公钥内容
- 填写标题，如"slick-agent-&lt;machine-name>"
...
elif [ -f ~/.slick/.env ] && grep -q "^GITHUB_TOKEN=" ~/.slick/.env; then
  export GITHUB_TOKEN=$(grep "^GITHUB_TOKEN=" ~/.slick/.env | head -1 | cut -d= -f2 | tr -d '\n\r')
  echo "AUTH_METHOD=curl"
