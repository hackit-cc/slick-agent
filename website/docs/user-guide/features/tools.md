...
Paid [Hackit Portal](https://portal.hackit.cc) subscribers can use web search, image generation, TTS, and browser automation through the **[Tool Gateway](tool-gateway.md)** — no separate API keys needed. Run `slick model` to enable it, or configure individual tools with `slick tools`.
:::
