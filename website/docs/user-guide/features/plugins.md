...
(`https://raw.githubusercontent.com/hackit-cc/slick-plugin-index/main/index.json`,
...
```json
{
  ...
  "repo": "Hackit/slick-media-studio",
  "ref": "<40-char commit SHA>",
  "subdir": null,
  "homepage": "https://github.com/hackit-cc/slick-media-studio",
...
[slick-plugin-index](https://github.com/hackit-cc/slick-plugin-index)
