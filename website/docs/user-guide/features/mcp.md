...
## Catalog: one-click install for Hackit-approved MCPs

Slick ships a curated catalog of MCP servers that Hackit staff has reviewed
...
Hackit approval. There is no community submission tier; entries are added by
merging a PR.
...
the slick-agent repo, so Hackit has reviewed each entry before it shipped —
...
Manifests live at
[`optional-mcps/<name>/manifest.yaml`](https://github.com/hackit-cc/slick-agent/tree/main/optional-mcps)
...
[`optional-mcps/`](https://github.com/hackit-cc/slick-agent/tree/main/optional-mcps).
