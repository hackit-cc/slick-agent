...
:::tip
Not using OpenAI Codex? `slick setup --portal` configures a non-Codex backend with Claude/Gemini/etc. in one step. See [Hackit Portal](/integrations/hackit-portal).
:::
...
If you find a bug, [open an issue](https://github.com/hackit-cc/slick-agent/issues) with the output of `slick logs --since 5m`. Mention `codex-runtime` in the title so it's easy to triage.
...
For implementation details, see [PR #24182](https://github.com/hackit-cc/slick-agent/pull/24182) and the [Codex app-server protocol README](https://github.com/openai/codex/blob/main/codex-rs/app-server/README.md).
