...
description: "Use your Hackit Portal subscription (or other OAuth provider) as an OpenAI-compatible endpoint for external apps"
---
...
This opens your browser for the Hackit Portal OAuth flow. Slick stores
...
Currently shipped: `hackit` (Hackit Portal) and `xai` (xAI / Grok). More
...
The proxy only forwards paths the upstream actually serves. For Hackit
Portal:
...
supports; check `portal.hackit.cc/models`.
...
[portal.hackit.cc](https://portal.hackit.cc).
