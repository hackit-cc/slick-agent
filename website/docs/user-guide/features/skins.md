...
|------|-------------|----------------|------------------|
| `default` | Classic Slick — gold and kawaii | `Slick Agent` | Warm gold borders, cornsilk text, kawaii faces in spinners. The familiar caduceus banner. Clean and inviting. |
