...
[`merge-reconciler` skill](https://github.com/hackit-cc/slick-agent/blob/main/skills/autonomous-ai-agents/merge-reconciler/SKILL.md)
...
guide](https://github.com/hackit-cc/slick-agent/blob/main/docs/kanban/multi-gateway.md)),
