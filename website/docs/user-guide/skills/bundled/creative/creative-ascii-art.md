...
```bash
python3 -m pyfiglet "SLICK" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=SLICK&font=Slant" | boxes -d stone
```
