...
| | |
|---|---|
| Source | Optional — install with `slick skills install official/data-science/jupyter-notebook` |
...
| `execute_code` | One-shot scripts needing slick tool access (web_search, file ops). Stateless. |
