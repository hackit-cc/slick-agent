...
```bash
python ~/.slick/skills/migration/openclaw-migration/scripts/openclaw_to_slick.py
```

When using the terminal tool, prefer an absolute invocation pattern such as:

```json
{"command":"python /home/USER/.slick/skills/migration/openclaw-migration/scripts/openclaw_to_slick.py","workdir":"/home/USER"}
```

Dry run with the user-data preset:

```bash
python ~/.slick/skills/migration/openclaw-migration/scripts/openclaw_to_slick.py --preset user-data
```

Execute a user-data migration:

```bash
python ~/.slick/skills/migration/openclaw-migration/scripts/openclaw_to_slick.py --execute --preset user-data --skill-conflict skip
```

Execute a full compatible migration:

```bash
python ~/.slick/skills/migration/openclaw-migration/scripts/openclaw_to_slick.py --execute --preset full --migrate-secrets --skill-conflict skip
```

Execute with workspace instructions included:

```bash
python ~/.slick/skills/migration/openclaw-migration/scripts/openclaw_to_slick.py --execute --preset user-data --skill-conflict rename --workspace-target "/absolute/workspace/path"
```
