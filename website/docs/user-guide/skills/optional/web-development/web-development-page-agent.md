...
| | |
|---|---|
| Source | Optional — install with `slick skills install official/web-development/page-agent` |
...
- User wants **Slick itself to drive a browser** → use Slick' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
