...
| | |
|---|---|
| Source | Optional — install with `slick skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.slick/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.slick/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Slick installs package this)
