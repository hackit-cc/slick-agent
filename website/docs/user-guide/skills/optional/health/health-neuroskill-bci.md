...
| | |
|---|---|
| Source | Optional — install with `slick skills install official/health/neuroskill-bci` |
...
Connect Slick to a running [NeuroSkill](https://neuroskill.com/) instance to read
