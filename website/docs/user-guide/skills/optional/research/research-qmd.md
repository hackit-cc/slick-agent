...
| | |
|---|---|
| Source | Optional — install with `slick skills install official/research/qmd` |
...
| Related skills | [`obsidian`](/docs/user-guide/skills/bundled/note-taking/note-taking-obsidian), [`slick-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-slick-agent), [`arxiv`](/docs/user-guide/skills/bundled/research/research-arxiv) |
...
Slick Agent via the native MCP client. This is the preferred
...
Then configure Slick Agent to connect via HTTP:
