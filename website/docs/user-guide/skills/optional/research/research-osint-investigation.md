...
| | |
|---|---|
| Source | Optional — install with `slick skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Slick Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
| License | MIT |
...
# $SLICK_OSINT_CACHE/icij/ (default: ~/.cache/slick-osint/icij/).
...
# Set SLICK_OSINT_UA=your-app/1.0 (your@email) to identify yourself
