...
```bash
python ~/.slick/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
```bash
python ~/.slick/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python ~/.slick/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
