...
| | |
|---|---|
| Source | Optional — install with `slick skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Slick Agent |
| License | MIT |
...
The script reads `${SLICK_HOME:-~/.slick}/.env` for two optional defaults:
...
Helper script: `~/.slick/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.slick/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${SLICK_HOME:-~/.slick}/.env`.
...
```bash
python3 ~/.slick/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.slick/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
