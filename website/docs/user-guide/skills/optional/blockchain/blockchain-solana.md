...
python ~/.slick/skills/blockchain/solana/scripts/solana_client.py stats
```
...
```bash
python ~/.slick/skills/blockchain/solana/scripts/solana_client.py \
...
```bash
python ~/.slick/skills/blockchain/solana/scripts/solana_client.py price BONK
python ~/.slick/skills/blockchain/solana/scripts/solana_client.py price JUP
python ~/.slick/skills/blockchain/solana/scripts/solana_client.py price SOL
python ~/.slick/skills/blockchain/solana/scripts/solana_client.py price DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263
```
