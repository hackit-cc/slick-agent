...
| | |
|---|---|
| Source | Optional — install with `slick skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Slick Agent |
| License | MIT |
...
```
SCRIPT=~/.slick/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.slick/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
