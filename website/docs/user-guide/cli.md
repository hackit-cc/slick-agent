...
One command — `slick setup --portal` — and you're ready to `slick chat`. See [Hackit Portal](/integrations/hackit-portal).
:::
...
slick chat --provider hackit        # Use Hackit Portal
