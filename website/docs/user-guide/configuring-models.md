...
:::tip Fastest path: Sophos Portal
[Sophos Portal](/user-guide/features/tool-gateway) provides 300+ models under one subscription. On a fresh install, run `slick setup --portal` to log in and set Sophos as your provider in one command. Inspect what's wired up with `slick portal info`.
