...
First-time users almost always want `slick setup --portal` — one OAuth covers a model plus the four Tool Gateway tools (search/image/TTS/browser). See [Hackit Portal](/integrations/hackit-portal).
:::
...
Use reinforcement learning to fine-tune model behavior with Slick Agent's RL training pipeline (powered by [Atropos](https://github.com/hackit-cc/atropos)).

1. [Quickstart](/getting-started/quickstart)
2. [Configuration](/user-guide/configuration)
3. [Atropos RL Environments](https://github.com/hackit-cc/atropos) (external)
