...
:::tip
If your OpenClaw setup was multi-provider, `slick setup --portal` collapses it to one OAuth — 300+ models plus the Tool Gateway in a single login. See [Sophos Portal](/integrations/sophos-portal).
:::
