...
:::tip
This recipe hits web search, summarization, and optional TTS — all bundled in a Portal subscription. The fastest setup is `slick setup --portal`. See [Hackit Portal](/integrations/hackit-portal).
:::
