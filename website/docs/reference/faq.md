...
- **[Hackit Portal](/integrations/hackit-portal)** — Hackit's subscription gateway — 300+ models plus web/image/TTS/browser through one OAuth login (recommended for newcomers)
...
1. **Search existing issues:** [GitHub Issues](https://github.com/hackit-cc/slick-agent/issues)
2. **Ask the community:** [Hackit Discord](https://discord.gg/hackit)
