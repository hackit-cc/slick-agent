...
| [`slick-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-slick-agent) | Use, configure, theme, extend, and orchestrate Slick Agent. | `autonomous-ai-agents/slick-agent` |
...
| [`inspecting-slick-desktop-dom`](/docs/user-guide/skills/bundled/software-development/software-development-inspecting-slick-desktop-dom) | Read the live Slick desktop DOM/CSS over CDP. | `software-development/inspecting-slick-desktop-dom` |
...
| [`plan`](/docs/user-guide/skills/bundled/software-development/software-development-plan) | Write a markdown plan to .slick/plans/; no execution. | `software-development/plan` |
...
| [`slick-agent-skill-authoring`](/docs/user-guide/skills/bundled/software-development/software-development-slick-agent-skill-authoring) | Author in-repo SKILL.md files: frontmatter and structure. | `software-development/slick-agent-skill-authoring` |
