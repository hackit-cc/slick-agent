...
slug: /
sidebar_position: 0
title: "Slick Agent Documentation"
description: "The self-improving AI agent built by Sophos Techne. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
...
The self-improving AI agent built by [Sophos Techne](https://sophostechne.com). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
After installing, run `slick setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [Sophos Portal](/integrations/sophos-portal).
:::
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)**                      | Connect to MCP servers, filter their tools, and extend Slick safely  |
| 🧭 **[Use MCP with Slick](/guides/use-mcp-with-slick)**               | Practical MCP setup patterns, examples, and tutorials                 |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)**                    | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Slick](/guides/use-voice-mode-with-slick)** | Hands-on setup and usage patterns for Slick voice workflows          |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)**        | Define Slick' default voice with a global SOUL.md                    |
...
| 💡 **[Tips & Best Practices](/guides/tips)**                            | Quick wins to get the most out of Slick                              |
...
- **Built by model trainers** — Created by [Sophos Techne](https://sophostechne.com), the lab behind Slick, Nomos, and Psyche. Works with [Sophos Portal](https://portal.sophostechne.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Full web control** — Search, extract, browse, vision, image generation, TTS — one subscription via [Sophos Portal](/integrations/sophos-portal) bundles all of them
- **MCP support** — Connect to any MCP server for extended tool capabilities
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Sophos Techne](https://sophostechne.com) — the lab behind Slick, Nomos, and Psyche models
