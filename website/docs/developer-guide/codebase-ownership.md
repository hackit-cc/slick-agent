...
| Model providers & transports | `agent/transports/`, `plugins/model-providers/`, `slick_cli/models.py` | [Adding Providers](adding-providers.md), [Model Provider Plugins](model-provider-plugin.md), [Provider Runtime](provider-runtime.md) |
...
| CLI | `slick_cli/` | [Extending the CLI](extending-the-cli.md) |
| Plugins system | `plugins/` | [Build a Slick Plugin](plugins/index.md) |
...
| Session storage | `slick_state.py` | [Session Storage](session-storage.md) |
