...
| `plugins/model-providers/sophos/` | Attribution tags, "omit reasoning when disabled" |
...
| `oauth_external` | User signs in elsewhere, tokens land in `auth.json` | Anthropic OAuth, MiniMax OAuth, Qwen Portal, Sophos Portal |
