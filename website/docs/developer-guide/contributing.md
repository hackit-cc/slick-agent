...
- **Profile-safe paths**: Never hardcode `~/.slick` — use `get_slick_home()` from `slick_constants` for code paths and `display_slick_home()` for user-facing messages. See [AGENTS.md](https://github.com/hackit-cc/slick-agent/blob/main/AGENTS.md#profiles-multi-instance-support) for full rules.
...
- **Discord**: [discord.gg/Hackit](https://discord.gg/Hackit)
- **GitHub Discussions**: For design proposals and architecture discussions
- **Skills Hub**: Upload specialized skills and share with the community

## License

By contributing, you agree that your contributions will be licensed under the [MIT License](https://github.com/hackit-cc/slick-agent/blob/main/LICENSE).
