...
- User-facing setup + troubleshooting: [Egress proxy](https://slick-agent.hackit.cc/docs/user-guide/egress/iron-proxy)
- Docker backend internals: [Docker](https://slick-agent.hackit.cc/docs/user-guide/docker)
- Bitwarden Secrets Manager integration: [`slick secrets bitwarden`](https://slick-agent.hackit.cc/docs/user-guide/secrets/bitwarden)
- CLI command reference: [`slick egress`](https://slick-agent.hackit.cc/docs/reference/cli-commands#slick-egress)
- Sandbox-injected environment variables: [Egress proxy (sandbox-injected)](https://slick-agent.hackit.cc/docs/reference/environment-variables#egress-proxy-sandbox-injected)
