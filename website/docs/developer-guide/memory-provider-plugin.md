...
|---|---|---|
| Bundled | `plugins/memory/<name>/` | Ships with Slick. Closed to new providers — see [CONTRIBUTING](https://github.com/hackit-cc/slick-agent/blob/main/CONTRIBUTING.md). |
