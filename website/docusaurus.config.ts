    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/hackit-cc/slick-agent/edit/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://slick-agent.hackit.cc/',
          label: 'Download',
          position: 'left',
        },
        {
        ...
        {
          href: 'https://github.com/hackit-cc/slick-agent',
          label: 'GitHub',
          position: 'right',
        },
        {
    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          title: 'Community',
          items: [
            { label: 'Discord', href: 'https://discord.gg/Hackit' },
            { label: 'GitHub Issues', href: 'https://github.com/hackit-cc/slick-agent/issues' },
        ...
        },
        {
          title: 'More',
          items: [
            { label: 'Desktop Download', href: 'https://slick-agent.hackit.cc/' },
            { label: 'GitHub', href: 'https://github.com/hackit-cc/slick-agent' },
            { label: 'Hackit', href: 'https://hackit.cc' },
          ],
        },
      ],
      copyright: `Built by <a href="https://hackit.cc">Hackit</a> · MIT License · ${new Date().getFullYear()}`,
    },
    prism: {
