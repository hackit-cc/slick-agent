...
const config: Config = {
  ...
  url: 'https://slick-agent.sophostechne.com',
  baseUrl: '/docs/',

  organizationName: 'SophosTechne',
      ...
      '@docusaurus/plugin-client-redirects',
      {
        ...
        redirects: [
          ...
          },
          {
            ...
            from: '/guides/build-a-slick-plugin',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/SophosTechne/slick-agent/edit/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    image: 'img/slick-agent-banner.png',
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://slick-agent.sophostechne.com/',
          label: 'Download',
          position: 'left',
        },
        {
        ...
        {
          href: 'https://github.com/SophosTechne/slick-agent',
          label: 'GitHub',
          position: 'right',
        },
        {
          href: 'https://discord.gg/SophosTechne',
          label: 'Discord',
          position: 'right',
        },
      ],
    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          title: 'Community',
          items: [
            { label: 'Discord', href: 'https://discord.gg/SophosTechne' },
            { label: 'GitHub Issues', href: 'https://github.com/SophosTechne/slick-agent/issues' },
        ...
        },
        {
          title: 'More',
          items: [
            { label: 'Desktop Download', href: 'https://slick-agent.sophostechne.com/' },
            { label: 'GitHub', href: 'https://github.com/SophosTechne/slick-agent' },
            { label: 'Sophos Techne', href: 'https://sophostechne.com' },
          ],
        },
      ],
      copyright: `Built by <a href="https://sophostechne.com">Sophos Techne</a> · MIT License · ${new Date().getFullYear()}`,
    },
    prism: {
