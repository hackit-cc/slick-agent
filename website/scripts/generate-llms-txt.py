...
Both publish at:
  https://slick-agent.hackit.cc/docs/llms.txt
  https://slick-agent.hackit.cc/docs/llms-full.txt
...
SITE_BASE = "https://slick-agent.hackit.cc/docs"
...
def emit_llms_index() -> str:
    ...
    lines.append("")
    lines.append(
        "> The self-improving AI agent built by Hackit. A terminal-native "
        ...
        "backends. Works with Hackit Portal, OpenRouter, OpenAI, Anthropic, Google, or any "
        "OpenAI-compatible endpoint."
    )
    lines.append("")
    lines.append(
        "Install: `curl -fsSL https://raw.githubusercontent.com/hackit-cc/"
        "slick-agent/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/hackit-cc/slick-agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    chunks: list[str] = [
        ...
        "Canonical site: https://slick-agent.hackit.cc/docs\n",
        "Short index: https://slick-agent.hackit.cc/docs/llms.txt\n",
        "\n---\n\n",
    ]
