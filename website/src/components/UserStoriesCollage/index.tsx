  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the Slick Agent community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use Slick &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with Slick?{' '}
        <a
          href="https://github.com/SophosTechne/slick-agent/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a href="https://discord.gg/SophosTechne" target="_blank" rel="noopener noreferrer">
          Sophos Techne Discord
        </a>{' '}
