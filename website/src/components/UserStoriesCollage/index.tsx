  ...
  return (
    <div className={styles.wrap}>
      ...
      <div className={styles.footer}>
        ...
        <a
          href="https://github.com/hackit-cc/slick-agent/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a href="https://discord.gg/Hackit" target="_blank" rel="noopener noreferrer">
          Hackit Discord
        </a>{' '}
