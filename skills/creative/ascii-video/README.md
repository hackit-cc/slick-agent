...
Built for [Slick Agent](https://github.com/SophosTechne/slick-agent). Usable in any coding agent. Canonical source lives here; synced to [`SophosTechne/slick-agent/skills/creative/ascii-video`](https://github.com/SophosTechne/slick-agent/tree/main/skills/creative/ascii-video) via PR.
