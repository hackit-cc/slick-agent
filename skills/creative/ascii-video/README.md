...
Built for [Slick Agent](https://github.com/hackit-cc/slick-agent). Usable in any coding agent. Canonical source lives here; synced to [`Hackit/slick-agent/skills/creative/ascii-video`](https://github.com/hackit-cc/slick-agent/tree/main/skills/creative/ascii-video) via PR.
