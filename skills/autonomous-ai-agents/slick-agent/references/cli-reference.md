...
https://slick-agent.sophostechne.com/docs/reference/cli-commands
...
Docs: https://slick-agent.sophostechne.com/docs/user-guide/messaging/
...
slick auth add [PROVIDER]  Add OAuth or API-key credential (sophos, openai-codex, qwen-oauth, …)
...
slick portal               Quick setup / sign in via Sophos Portal
...
|---|---|
| Config options | `slick config edit` · [Configuration docs](https://slick-agent.sophostechne.com/docs/user-guide/configuration) |
| Tools / toolsets | `slick tools list` · [Tools reference](https://slick-agent.sophostechne.com/docs/reference/tools-reference) |
| Skills catalog | `slick skills browse` · [Skills catalog](https://slick-agent.sophostechne.com/docs/reference/skills-catalog) |
| Provider setup | `slick model` · [Providers guide](https://slick-agent.sophostechne.com/docs/integrations/providers) |
| Env variables | `slick config env-path` · [Env vars reference](https://slick-agent.sophostechne.com/docs/reference/environment-variables) |
