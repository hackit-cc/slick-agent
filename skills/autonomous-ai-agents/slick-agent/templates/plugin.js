/**
 * Slick desktop plugin template. Save as:
 *   <slick home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <slick home> is ~/.slick by default, or ~/.slick/profiles/<name>
 * when running a named profile (`slick -p <name>`). Run `slick doctor` (or
 ...
 * Only these imports resolve: @slick/plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@slick/plugin-sdk'
