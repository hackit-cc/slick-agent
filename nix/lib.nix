      ...
      let
        ...
        excludedDirs =
          ...
          jsWorkspaceTopDirs ++ [
            ...
            "nix"
            # Skills are shipped via SLICK_BUNDLED_SKILLS /
            # SLICK_OPTIONAL_SKILLS (see slick-agent.nix), not via the
            ...
            # __init__.py) shipped via symlinks + SLICK_BUNDLED_LOCALES
            # / SLICK_OPTIONAL_MCPS, not via the wheel. Excluding them
