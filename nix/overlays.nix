# nix/overlays.nix — Expose pkgs.slick-agent for external NixOS configs
#
...
# `pkgs.slick-agent`, `nix build .#default`, and the NixOS module's
...
{ inputs, ... }:
{
  flake.overlays.default = final: _: {
    slick-agent = inputs.self.packages.${final.stdenv.hostPlatform.system}.default;
  };
}
