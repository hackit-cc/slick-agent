...
def _profile_user_agent() -> str:
    """Return a ``slick-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from slick_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"slick-cli/{_ver}"
    except Exception:
        return "slick-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # slick-cli UA so the catalog endpoint is reachable.
