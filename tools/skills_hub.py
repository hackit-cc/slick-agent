...
class OptionalSkillSource(SkillSource):
    ...
    These skills are official (maintained by Hackit) but not activated
    ...
    OFFICIAL_REPO = "Hackit/slick-agent"
...
SLICK_INDEX_URL = "https://slick-agent.hackit.cc/docs/api/skills-index.json"
