...
def _resolve_backend_cdp(
    ...
    3. A configured cloud browser provider (Browserbase, Firecrawl, Hackit
    ...
    # Hackit-gateway variant (use_gateway: true) DOES resolve through the
...
def browser_exec(
    ...
    # Hackit gateway, CDP override, local Chrome, …). Named sessions compose
