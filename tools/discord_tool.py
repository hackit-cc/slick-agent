...
Only included in the slick-discord toolset, so it has zero cost
...
def _discord_request(
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "Slick-Agent (https://github.com/SophosTechne/slick-agent)",
        },
    )
...
def _capability_disk_cache_path() -> "Path":
    ...
    return get_slick_home() / "cache" / "discord_capabilities.json"
