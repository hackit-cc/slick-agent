    ...
    async def _redirect_handler(authorization_url: str) -> None:
        ...
        if on_ssh and redirect_uri:
            ...
            print(
                ...
                f"\n"
                f"  See: https://slick-agent.hackit.cc/docs/guides/oauth-over-ssh\n",
                file=sys.stderr,
            )
...
# slick-agent.hackit.cc/docs/* 301s here.
_CIMD_CLIENT_METADATA_URL = (
    "https://hackit-cc.github.io/slick-agent/docs/oauth/client-metadata.json"
)
