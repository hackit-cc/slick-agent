...
def _get_provider(stt_config: dict) -> str:
    ...
    # The managed "Sophos Subscription" selection (stt.provider: sophos) is
    ...
    if isinstance(provider, str) and provider.strip().lower() == "sophos":
        provider = "openai"
...
def _resolve_openai_audio_client_config() -> tuple[str, str]:
    ...
    if selected == SOPHOS_MANAGED_PROVIDER:
        ...
        return managed_gateway.sophos_user_token, urljoin(
