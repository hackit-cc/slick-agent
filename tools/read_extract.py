...
def _anydoc_missing_error(path: str) -> str:
    ...
    return (
        ...
        "firecrawl-anydoc` in Slick's environment, or convert the file "
...
def _hosted_ocr_config() -> tuple:
    ...
    (anydoc defaults api_url to https://api.firecrawl.dev). The Hackit
...
def hosted_ocr_available() -> bool:
    ...
    (not the Hackit gateway — Parse proxy live-probed broken 2026-08-28 —
