...
supports multiple backends — **Browser Use** (cloud, default for Hackit
...
def _resolve_cloud_provider_uncached() -> Optional[CloudBrowserProvider]:
    ...
    fallback. If unset, fall back to Browser Use (managed Hackit gateway or
    ...
    try:
        ...
        if isinstance(browser_cfg, dict) and "cloud_provider" in browser_cfg:
            ...
            if provider_key in ("local", "camofox"):
                ...
                _cloud_provider_resolved = True
                return None
            if provider_key == "hackit":
                # Managed "Hackit Subscription" selection is serviced by the
    ...
    if resolved is None and provider_key is None:
        ...
        # was ever written: Browser Use first (managed Hackit gateway or
        ...
        try:
            ...
            if _requires_real_termux_browser_install(browser_cmd):
                ...
                if _running_in_docker():
                    ...
                    print("       docker pull ghcr.io/hackit-cc/slick-agent:latest")
                else:
