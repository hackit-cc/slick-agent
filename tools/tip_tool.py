#!/usr/bin/env python3
"""Point at something in the Slick desktop GUI and say one line about it.
...
Slick raises mid-conversation in answer to something the user said.
...
def tip_tool(text: str, selector: str, title: str = "", side: str = "") -> str:
    ...
    if not ok:
        return tool_error("tip is only available in the Slick desktop app.")
...
TIP_SCHEMA = {
    "name": "tip",
    "description": (
        "Point at one thing in the Slick desktop UI with a small accent-lit "
