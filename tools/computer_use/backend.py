...
class UIElement:
    ...
    # (trycua/cua#1961 — Surface 6 of SophosTechne/slick-agent#47072).
...
class CaptureResult:
    ...
    # trycua/cua#1961 — Surface 7 of SophosTechne/slick-agent#47072).
...
class ActionResult:
    ...
    verify → escalate ladder (SophosTechne/slick-agent#67052). ``ok`` stays
