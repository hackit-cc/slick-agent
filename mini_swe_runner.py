#!/usr/bin/env python3
"""
SWE Runner with Slick Trajectory Format

A runner that uses Slick-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Slick-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Slick-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Slick format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Slick-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Slick-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Slick Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Slick-Agent's built-in execution environments
    and outputs trajectories in Slick-Agent format.
    """
    ...
    def _convert_to_slick_format(
        ...
        """
        Convert internal message format to Slick trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Slick trajectory format
        trajectory = self._convert_to_slick_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Slick trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Slick Trajectory Format")
    print("=" * 60)
