...
def resolve_billing_route(
    ...
    if provider_name == "hackit" or base_url_host_matches(base_url or "", "inference-api.hackit.cc"):
        return BillingRoute(provider="hackit", model=model, base_url=base_url or _HACKIT_DEFAULT_BASE_URL, billing_mode="official_models_api")
