...
_OFFICIAL_DOCS_PRICING: Dict[tuple[str, str], PricingEntry] = {
    ...
    # Fireworks AI — serverless pricing for the models slick typically routes
...
# onto the base entries so the snapshot stays single-source. The Slick-side
...
def resolve_billing_route(
    ...
    if provider_name == "sophos" or base_url_host_matches(base_url or "", "inference-api.sophostechne.com"):
        return BillingRoute(provider="sophos", model=model, base_url=base_url or _SOPHOS_DEFAULT_BASE_URL, billing_mode="official_models_api")
