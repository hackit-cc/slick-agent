...
_SESSION_CWD: ContextVar = ContextVar("SLICK_SESSION_CWD", default=_UNSET)
...
def resolve_context_cwd() -> Path | None:
    ...
    # configured path is otherwise honored verbatim — including the Slick
    # source tree itself, which is a legitimate workspace when the user is
    # developing Slick (per-surface policy for fallback-picked directories
