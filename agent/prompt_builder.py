...
DEFAULT_AGENT_IDENTITY = (
    "You are Slick Agent, an intelligent AI assistant created by Hackit. "
...
SLICK_AGENT_HELP_GUIDANCE = (
    "You run on Slick Agent (by Hackit). When the user needs help with "
    "Slick itself — configuring, setting up, using, extending, or troubleshooting "
    "it — or when you need to understand your own features, tools, or capabilities, "
    "the documentation at https://slick-agent.hackit.cc/docs is your "
...
SLICK_AGENT_HELP_GUIDANCE_NO_SKILLS = (
    ...
    "Slick itself — configuring, setting up, using, extending, or troubleshooting "
    "it — or when you need to understand your own features, tools, or capabilities, "
    "the documentation at https://slick-agent.hackit.cc/docs is the "
    "authoritative reference and always holds the latest, most up-to-date "
