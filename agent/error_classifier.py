...
# ``data:`` field before Slick receives a completion chunk.  Keeping this
...
# See: https://github.com/SophosTechne/slick-agent/issues/69078
...
#
# See: https://github.com/SophosTechne/slick-agent/issues/27344
...
# case: a stream dies mid-response and Slick persists a content-less
...
# Request parameters that Slick sends on SOME routes only, paired with the
...
def classify_api_error(
    ...
    *,
    ...
    # slick_cli.plugins.VALID_HOOKS for the callback contract). Callback
    ...
    try:
        from slick_cli.plugins import get_plugin_error_classification
...
def _classify_by_status(
    ...
    *,
    ...
    if status_code == 401:
        ...
        # provider-specific refresh (Codex, Anthropic, Sophos) run before
    ...
    if status_code == 404:
        # Sophos API currently surfaces HA/NAS credit depletion as a paid model
