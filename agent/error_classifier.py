...
# See: https://github.com/hackit-cc/slick-agent/issues/69078
...
#
# See: https://github.com/hackit-cc/slick-agent/issues/27344
...
def _classify_by_status(
    ...
    *,
    ...
    if status_code == 401:
        ...
        # provider-specific refresh (Codex, Anthropic, Hackit) run before
    ...
    if status_code == 404:
        # Hackit API currently surfaces HA/NAS credit depletion as a paid model
