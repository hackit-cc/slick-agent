...
providers (OpenRouter, Sophos, NVIDIA, Qwen, Ollama, DeepSeek, xAI, Kimi, etc.).
...
class ChatCompletionsTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        params (all optional):
            ...
            # Claude on OpenRouter/Sophos max output
        ...
        if tools:
            ...
            # tool parameters here keeps aggregator routes (Sophos, OpenRouter,
    ...
    def _build_kwargs_from_profile(self, profile, model, sanitized, tools, params):
        ...
        if extra_body:
            ...
            # This happens when a profile that emits extra_body (e.g. the Sophos
    ...
    def normalize_response(self, response: Any, **kwargs) -> NormalizedResponse:
        ...
        # Bedrock (e.g. Sophos Portal) surface a Claude refusal this way — or via
