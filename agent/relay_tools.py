"""Core NeMo Relay adapter for Slick tool execution."""
    ...
    try:
        ...
        if (
            ...
            logger.warning(
                ...
                "returning the Slick tool result",
                exc_info=True,
            )
...
def _run_awaitable(value: Any) -> Any:
    ...
    raise RuntimeError(
        "Synchronous Slick Relay tool execution cannot run on an active event-loop thread"
    )
