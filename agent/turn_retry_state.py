...
anthropic, sophos, copilot), a long-context compression restart, a length-
...
class TurnRetryState:
    ...
    sophos_auth_retry_attempted: bool = False
    sophos_paid_entitlement_refresh_attempted: bool = False
