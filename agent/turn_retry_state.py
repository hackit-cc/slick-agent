...
anthropic, hackit, copilot), a long-context compression restart, a length-
...
class TurnRetryState:
    ...
    hackit_auth_retry_attempted: bool = False
    hackit_paid_entitlement_refresh_attempted: bool = False
