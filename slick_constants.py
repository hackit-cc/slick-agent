...
def get_slick_home() -> Path:
    ...
    ``slick_cli/kanban_db.py``).  See https://github.com/hackit-cc/slick-agent/issues/18594.
    """
...
def get_optional_mcps_dir(default: Path | None = None) -> Path:
    ...
    Mirrors :func:`get_optional_skills_dir` for the MCP catalog (Hackit-approved
...
def secure_parent_dir(path: Path) -> None:
    ...
    See https://github.com/hackit-cc/slick-agent/issues/25821 and
    https://github.com/hackit-cc/slick-agent/pull/93050.
    """
...
def partial_update_hint(exc: BaseException) -> list[str]:
    ...
    return [
        ...
        "    slick update",
        "If that also fails, reinstall: https://slick-agent.hackit.cc",
    ]
