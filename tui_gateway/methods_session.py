...
def _(rid, params: dict) -> dict:
    ...
    # Hackit credits block — agent-independent (a portal fetch), so it shows even
    # with zero API calls or on a resumed session. The TUI /usage panel renders
    # these lines regardless of `calls`. Fail-open: [] when not logged into Hackit
    # or on any portal hiccup.
    try:
        from agent.account_usage import hackit_credits_lines

        credits = hackit_credits_lines()
        if credits:
...
def _(rid, params: dict) -> dict:
    ...
    True only when a reference-capable image backend (Hackit Portal / OpenRouter /
...
def _(rid, params: dict) -> dict:
    ...
    from slick_cli.hackit_billing import BillingError, post_subscription_preview
...
def _(rid, params: dict) -> dict:
    ...
    billing:manage.
    """
    from slick_cli.hackit_billing import BillingError, put_subscription_pending_change
...
def _(rid, params: dict) -> dict:
    ...
    """
    from slick_cli.hackit_billing import BillingError, delete_subscription_pending_change
...
def _(rid, params: dict) -> dict:
    ...
    from slick_cli.hackit_billing import BillingError, post_subscription_upgrade
...
def _(rid, params: dict) -> dict:
    ...
    """
    from slick_cli.hackit_billing import BillingError, get_charge_status
...
def _(rid, params: dict) -> dict:
    ...
    """
    from slick_cli.hackit_billing import BillingError, patch_auto_top_up
...
def _(rid, params: dict) -> dict:
    ...
    try:
        ...
        from slick_cli.hackit_billing import BillingError
        ...
        granted = step_up_hackit_billing_scope(
