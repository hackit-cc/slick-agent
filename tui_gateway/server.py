...
_LONG_HANDLERS = frozenset(
    {
        ...
        # pool checks, pricing fetch, Hackit tier check, optional custom-provider
...
def _stored_session_runtime_overrides(row: dict | None) -> dict:
    ...
    # Hackit (or any earlier provider) long after the profile was switched —
    # every room message then failed with "out of Hackit credits" while the
    ...
    # provider (e.g. "out of Hackit credits" after the profile was switched to
    ...
    *,
    ...
    def run():
        ...
        try:
            ...
            # billing_url, is_hackit, message) so the TUI/desktop render a
