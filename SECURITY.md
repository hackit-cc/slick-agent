...
Report privately via [GitHub Security Advisories](https://github.com/hackit-cc/slick-agent/security/advisories/new)
or **security@hackit.cc**. Do not open public issues for
