...
or change arbitrary Slick configuration.
...
small host fact requested by the RFC. Settings writes use Slick'
...
`SLICK_HOME`, so one globally loaded plugin context follows multiplexed
...
```text
<SLICK_HOME>/plugin-data/<plugin-data-namespace>/state.json
```
...
The implementation is covered with real temporary-Slick-home tests for:
...
- [Issue #64227](https://github.com/SophosTechne/slick-agent/issues/64227)
- [RFC PR #58542](https://github.com/SophosTechne/slick-agent/pull/58542) by Topher Ross
