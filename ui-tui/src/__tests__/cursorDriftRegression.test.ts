 ...
 *
 * Symptom: in `slick --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@slick/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using slick --tui and as i type multiline my caret at the end will often ' +
