...
import { artWidth, hero, SMILY_WIDTH, logo, LOGO_WIDTH } from '../banner.js'
...
const TAG_FULL = 'Hackit · Messenger of the Digital Gods'
const TAG_MID = 'Messenger of the Digital Gods'
const TAG_TINY = 'Hackit'
const HIDE_BELOW = 34
  ...
  const heroColumn = wide ? (
    <Box flexDirection="column" width="100%">
      ...
      <Text color={t.color.accent}>
        ...
        <Text color={t.color.muted}> · Hackit</Text>
      </Text>
