import { Box, type ScrollBoxHandle, stringWidth, Text } from '@slick/ink'
...
export function StatusRule({
  ...
  // Dev-only readout (SLICK_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (SLICK_DEV_CREDITS), lowest priority,
