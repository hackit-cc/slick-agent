...
import type { ScrollBoxHandle } from '@slick/ink'
import { evictInkCaches } from '@slick/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.SLICK_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
