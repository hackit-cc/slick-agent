import type { BillingBlock, UsageModelData } from '@slick/shared/billing'
import type { SlickSkin } from '@slick/shared/skin'

import type { SessionInfo, SlashCategory, SubagentStatus, Usage } from './types.js'

/** The cross-surface skin contract (canonical shape in `@slick/shared`).
 *  Includes the paired light_colors/dark_colors overlays from #20379. */
export type GatewaySkin = SlickSkin
...
// Wire shapes now live in @slick/shared for reuse by TypeScript clients.
export type {
  BillingAutoReload,
  BillingBlock,
  BillingCardInfo,
