...
describe('billingDialogCopy', () => {
  it('routes Sophos to the /topup flow', () => {
    const copy = billingDialogCopy(makeBlock({ is_sophos: true, provider: 'sophos', provider_label: 'Sophos Portal' }))
    expect(copy.title).toContain('Sophos')
