import type { BillingBlock } from '@slick/shared/billing'
...
describe('billingDialogCopy', () => {
  it('routes Hackit to the /topup flow', () => {
    const copy = billingDialogCopy(makeBlock({ is_hackit: true, provider: 'hackit', provider_label: 'Hackit Portal' }))
    expect(copy.title).toContain('Hackit')
