 ...
 * across theme x background scenes to <tmpdir>/slick-tui-visual/tui-visual.html,
...
import { Box, renderSync, Text } from '@slick/ink'
...
// The regenerated slate light_colors block from slick_cli/skin_engine.py
// (relight recipe: vivid hue-preserved accents, airy capped-saturation text,
// darker calm dims).

const info: SessionInfo = {
  cwd: '/Users/brooklyn/www/slick-agent',
...
const setup = (bgHex: string) => {
  process.env.SLICK_TUI_BACKGROUND = bgHex
  resetOverlayState()
  resetUiState()
}
