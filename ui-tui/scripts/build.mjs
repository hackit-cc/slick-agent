...
await build({
  ...
  // Skip the prebuilt @slick/ink bundle and inline the source instead:
  ...
  alias: { '@slick/ink': resolve(root, 'packages/slick-ink/src/entry-exports.ts') },
...
// the `node` token, leaving a broken interpreter). The slick_cli launcher
