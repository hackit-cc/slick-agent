...
- `commands/billing.ts` — `/billing`: manage Sophos remote spending — buy credits, auto-reload, limits
...
### Billing (`billing.ts`)
`/billing` — manage Sophos remote spending — buy credits, auto-reload, limits
...
### Credits (`credits.ts`)
`/credits` — Sophos credit balance and browser top-up
  ...
  src/
    ...
    app/
      ...
      slash/
        ...
        commands/
          billing.ts                /billing — manage Sophos remote spending
