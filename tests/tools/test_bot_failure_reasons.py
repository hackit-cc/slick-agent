...
FIXTURE_NO_PROVIDER = (
    "agent init failed: No LLM provider configured. Run `slick model` to select "
    "a provider, or run `slick setup` for first-time configuration."
)
FIXTURE_NO_TOKEN = "agent init failed: No access token found for Hackit Portal login."
