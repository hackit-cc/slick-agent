...
class TestTerminalRequirements:
    ...
    def test_terminal_and_execute_code_tools_resolve_for_managed_modal(self, monkeypatch, tmp_path):
        monkeypatch.setattr("tools.tool_backend_helpers.managed_sophos_tools_enabled", lambda: True)
        monkeypatch.setattr(terminal_tool_module, "managed_sophos_tools_enabled", lambda: True)
