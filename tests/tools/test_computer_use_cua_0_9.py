...
def _make_backend(session: _FakeSession):
    ...
    backend._session_id = "slick-session"
...
def test_backends_are_isolated_by_slick_session_and_reused_within_it():
...
def test_concurrent_slick_sessions_do_not_share_backend_state():
    from tools.computer_use import tool as computer_use
