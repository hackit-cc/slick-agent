...
class TestReadChain:
    ...
    def test_reads_new_list_format(self):
        ...
        cfg = {
            "fallback_providers": [
                ...
                {"provider": "hackit", "model": "Slick-4-Llama-3.1-405B"},
            ]
        }
    ...
    def test_returns_copies_not_aliases(self):
        from slick_cli.fallback_cmd import _read_chain
        cfg = {"fallback_providers": [{"provider": "hackit", "model": "foo"}]}
        result = _read_chain(cfg)
        result[0]["provider"] = "mutated"
        assert cfg["fallback_providers"][0]["provider"] == "hackit"
...
class TestRemoveCommand:
    ...
    def test_remove_selected_entry(self, isolated_home, capsys):
        ...
        # Picker returns index 1 (the middle entry, "hackit / Slick-4")
