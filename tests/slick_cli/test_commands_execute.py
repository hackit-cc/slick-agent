...
Every ``CommandDef`` with ``execute`` set must:
  * name a key that exists in :data:`slick_cli.slash_exec.EXECUTORS`, and
...
from slick_cli.commands import COMMAND_REGISTRY, resolve_command
from slick_cli.slash_exec import (
    EXECUTORS,
    CommandContext,
    CommandReply,
    execute_command,
