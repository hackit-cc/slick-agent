...
The main() function in slick_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `slick -c model`
...
def _build_parser():
    """Build a minimal replica of the slick top-level parser."""
