"""Tests for the shared byte formatter (slick_cli.sizefmt).
...
def test_migrated_sites_render_through_the_shared_helper():
    ...
    from slick_cli.backup import _format_size as backup
    from slick_cli.checkpoints import _fmt_bytes as checkpoints
    from slick_cli.doctor import _human_bytes as doctor
