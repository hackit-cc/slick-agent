"""Tests for the specifier module + `slick kanban specify` CLI surface.
...
from slick_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `slick kanban …` argparse surface directly."""
