...
SAMPLE = _index_doc(
    [
        ...
        },
        {
            ...
            "repo": "Hackit/slick-telegram-business",
            "ref": "f" * 40,
        ...
        },
        {
            ...
            "author": "Hackit",
            "tags": ["example", "llm"],
            "repo": "Hackit/slick-example-plugins",
...
class TestParsing:
    def test_parses_object_form(self):
        ...
        assert entries[2].install_identifier == (
            "Hackit/slick-example-plugins/plugin-llm-example"
        )
        assert entries[0].install_identifier == "Hackit/slick-media-studio"
...
class TestResolveName:
    ...
    def test_exact_unique(self):
        ...
        assert entry is not None and entry.repo == "Hackit/slick-media-studio"
...
class TestInstallResolution:
    ...
    def test_install_resolves_name_and_pins_ref(self, slick_home, monkeypatch):
        ...
        assert captured["identifier"] == "Hackit/slick-media-studio"
...
class TestCmdSearch:
    def test_json_output(self, slick_home, monkeypatch, capsys):
        ...
        assert payload["results"][0]["repo"] == "Hackit/slick-telegram-business"
