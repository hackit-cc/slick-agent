"""Regression: ``slick update`` should take a managed checkout off autocrlf=true.
...
``slick update`` has to repair them.
...
from slick_cli.update_cmd import _normalize_managed_eol
