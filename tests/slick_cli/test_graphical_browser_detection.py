"""Tests for `_can_open_graphical_browser()` in slick_cli.auth.

Guards the fix for the May 2026 report where `slick auth add xai-oauth`
...
from slick_cli.auth import _can_open_graphical_browser
