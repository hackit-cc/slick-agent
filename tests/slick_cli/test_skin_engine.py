"""Tests for slick_cli.skin_engine — the data-driven skin/theme system."""
...
def reset_skin_state():
    ...
    from slick_cli import skin_engine
...
class TestSkinConfig:
    def test_default_skin_has_required_fields(self):
        from slick_cli.skin_engine import load_skin
...
class TestBuiltinSkins:
    def test_ares_skin_loads(self):
        ...
        assert r > g and r > b, f"ruby border lost its crimson: {border}"
        ...
        assert skin.get_branding("agent_name") == "Ruby Agent"
...
class TestSkinManagement:
    def test_set_active_skin(self):
        from slick_cli.skin_engine import set_active_skin, get_active_skin, get_active_skin_name
        skin = set_active_skin("ruby")
        assert skin.name == "ruby"
        assert get_active_skin_name() == "ruby"
        assert get_active_skin().name == "ruby"
...
class TestUserSkins:
    def test_load_user_skin_from_yaml(self, tmp_path, monkeypatch):
        ...
        # Patch skins dir
        monkeypatch.setattr("slick_cli.skin_engine._skins_dir", lambda: skins_dir)
    ...
    def test_load_user_skin_invalid_section_types_fall_back_to_defaults(self, tmp_path, monkeypatch):
        ...
        assert skin.get_branding("agent_name") == "Slick Agent"
...
class TestDisplayIntegration:
    ...
    def test_tool_message_uses_skin_prefix(self):
        from slick_cli.skin_engine import set_active_skin
        from agent.display import get_cute_tool_message
        set_active_skin("ruby")
...
class TestCliBrandingHelpers:
    ...
    def test_active_goodbye_ares(self):
        from slick_cli.skin_engine import set_active_skin, get_active_goodbye

        set_active_skin("ruby")
        assert get_active_goodbye() == "Farewell, warrior! ⚔"

    def test_prompt_toolkit_style_overrides_cover_tui_classes(self):
        from slick_cli.skin_engine import set_active_skin, get_prompt_toolkit_style_overrides
        set_active_skin("ruby")
    ...
    def test_prompt_toolkit_style_overrides_use_skin_colors(self):
        from slick_cli.skin_engine import (
            set_active_skin,
            get_active_skin,
