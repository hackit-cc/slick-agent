...
def test_vertex_registered_in_provider_registry():
    """PROVIDER_REGISTRY (slick_cli.auth) is what agent/auxiliary_client.py's
...
def test_vertex_registered_in_slick_overlays():
    """slick_cli.providers.get_provider("vertex") backs
