...
class TestStatusEndpointTopology:
    ...
    def _setup_client(self, monkeypatch, _isolate_slick_home):
        try:
    ...
    def test_profile_names_and_mode_public_when_auth_gated(self, monkeypatch):
        ...
        # Slick Cloud Portal reads /api/status over the network (a gated bind)
        ...
        try:
            ...
            # alongside slick_home / gateway_pid.
            assert "gateways" not in data
            assert "slick_home" not in data
