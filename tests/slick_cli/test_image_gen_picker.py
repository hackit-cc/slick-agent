...
class TestConfigWriting:
    ...
    def test_plugin_provider_active_overrides_managed_sophos_active_label(self, monkeypatch):
        from slick_cli import tools_config
        ...
        monkeypatch.setattr(
            ...
            lambda config, **kwargs: SimpleNamespace(
                features={"image_gen": SimpleNamespace(managed_by_sophos=True)}
            ),
        )
        ...
        assert tools_config._is_provider_active(sophos_row, config) is False
