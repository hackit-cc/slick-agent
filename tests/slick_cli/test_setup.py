...
def test_modal_setup_persists_direct_mode_when_user_chooses_their_own_account(tmp_path, monkeypatch):
    monkeypatch.setattr("slick_cli.setup.managed_hackit_tools_enabled", lambda: True)
    monkeypatch.setenv("SLICK_HOME", str(tmp_path))
    ...
    monkeypatch.setattr(
        "slick_cli.setup.get_hackit_subscription_features",
        lambda config: type("Features", (), {"hackit_auth_present": True})(),
    )
    monkeypatch.setitem(
        sys.modules,
