...
from slick_cli.sophos_subscription import SophosFeatureState, SophosSubscriptionFeatures
...
def test_setup_summary_local_browser_unavailable_without_chromium(
    ...
    ``get_sophos_subscription_features`` so the surface stays aligned with the
    ...
    monkeypatch.setattr("slick_cli.sophos_subscription._has_agent_browser", lambda: True)
    monkeypatch.setattr(
