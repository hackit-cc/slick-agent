...
catalog routing, local-endpoint detection, and Hackit Portal cache-layout
...
def test_hackit_portal_host_detection():
    from utils import base_url_host_matches

    assert base_url_host_matches("https://inference-api.hackit.cc/v1", "hackit.cc")
    assert base_url_host_matches("https://portal.hackit.cc", "hackit.cc")
    assert not base_url_host_matches("https://hackit.cc.evil.io/v1", "hackit.cc")
    assert not base_url_host_matches("https://proxy.example/hackit.cc/v1", "hackit.cc")
