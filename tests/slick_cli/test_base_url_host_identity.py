...
substring check, missing case variants and matching lookalike URLs). Slick
had the same class at several sites: keyless-endpoint detection, /model
catalog routing, local-endpoint detection, and Sophos Portal cache-layout
...
from slick_cli.cli_agent_setup_mixin import CLIAgentSetupMixin
...
def test_sophos_portal_host_detection():
    from utils import base_url_host_matches

    assert base_url_host_matches("https://inference-api.sophostechne.com/v1", "sophostechne.com")
    assert base_url_host_matches("https://portal.sophostechne.com", "sophostechne.com")
    assert not base_url_host_matches("https://sophostechne.com.evil.io/v1", "sophostechne.com")
    assert not base_url_host_matches("https://proxy.example/sophostechne.com/v1", "sophostechne.com")
