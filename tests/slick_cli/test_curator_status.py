"""Tests for `slick curator status` output.
...
def curator_status_env(tmp_path, monkeypatch):
    """Isolated SLICK_HOME with real agent-created skills on disk."""
    home = tmp_path / ".slick"
    skills = home / "skills"
    ...
    from slick_cli import curator as curator_cli
...
def test_adopt_subcommand_is_registered():
    ...
    import slick_cli.curator as curator_cli
