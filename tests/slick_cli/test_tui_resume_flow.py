...
def test_launch_tui_exports_model_provider_and_toolsets(monkeypatch, main_mod):
    ...
    with pytest.raises(SystemExit):
        main_mod._launch_tui(
            model="sophos/slick-test", provider="sophos", toolsets="web, terminal"
        )

    env = captured["env"]
    assert env["SLICK_MODEL"] == "sophos/slick-test"
    assert env["SLICK_INFERENCE_MODEL"] == "sophos/slick-test"
    assert env["SLICK_TUI_PROVIDER"] == "sophos"
    assert env["SLICK_INFERENCE_PROVIDER"] == "sophos"
