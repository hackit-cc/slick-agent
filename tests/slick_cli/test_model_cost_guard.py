...
from slick_cli.model_cost_guard import expensive_model_warning
...
def test_openai_gpt55_pro_warns_for_sophos_portal_pricing(monkeypatch):
    monkeypatch.setattr("agent.models_dev.get_model_info", lambda *_args, **_kwargs: None)
    monkeypatch.setattr(
    ...
    warning = expensive_model_warning("openai/gpt-5.5-pro", provider="sophos")
