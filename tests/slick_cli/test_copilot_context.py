...
class TestGetCopilotModelContext:
    ...
    @patch("slick_cli.models.fetch_github_model_catalog", return_value=_SAMPLE_CATALOG)
    ...
    @patch("slick_cli.models._urlopen_model_catalog_request")
    ...
    @patch("slick_cli.models.fetch_github_model_catalog", return_value=[])
