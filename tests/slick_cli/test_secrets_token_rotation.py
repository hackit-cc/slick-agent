"""Tests for `slick secrets bitwarden token` / `slick secrets onepassword token`.
...
from slick_cli import onepassword_secrets_cli as op_cli
from slick_cli import secrets_cli as bw_cli
