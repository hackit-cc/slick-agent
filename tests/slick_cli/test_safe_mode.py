"""Tests for `slick chat --safe-mode` isolation."""
...
_VARS = ("SLICK_SAFE_MODE", "SLICK_IGNORE_USER_CONFIG", "SLICK_IGNORE_RULES")
...
def test_cmd_chat_safe_mode_sets_env_before_startup(monkeypatch):
    ...
    def fake_has_provider() -> bool:
        assert os.environ["SLICK_SAFE_MODE"] == "1"
        assert os.environ["SLICK_IGNORE_USER_CONFIG"] == "1"
        assert os.environ["SLICK_IGNORE_RULES"] == "1"
        return True
