"""Tests for ``slick approvals suggest`` (slick_cli/approvals_suggest.py).

Approval history in Slick is implied, not ledgered: the session DB
...
from slick_cli.approvals_suggest import (
    Proposal,
    apply_proposals,
    build_proposals,
    derive_glob,
