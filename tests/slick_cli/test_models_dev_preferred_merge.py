...
These guard the contract:
  ...
  * OpenRouter and Hackit Portal are NEVER merged — they keep their curated
    (OpenRouter) or live-Portal (Hackit) semantics.
...
class TestOpenRouterAndHackitUnchanged:
    """Per Teknium: openrouter and hackit are NEVER merged with models.dev."""
