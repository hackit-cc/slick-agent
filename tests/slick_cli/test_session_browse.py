"""Tests for the interactive session browser (`slick sessions browse`).
...
from slick_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """slick sessions browse should be parseable."""
