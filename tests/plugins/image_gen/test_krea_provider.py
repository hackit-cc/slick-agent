...
# ---------------------------------------------------------------------------
# Managed Sophos gateway path
# ---------------------------------------------------------------------------


def _managed_cfg(
    origin: str = "https://krea-gateway.example.com",
    token: str = "sophos-tok-abc",
):
    ...
    return SimpleNamespace(
        ...
        sophos_user_token=token,
        managed_mode=True,
    )


class TestManagedGateway:
    def test_managed_submit_uses_gateway_origin_and_sophos_token(self, monkeypatch):
        """Managed mode submits to the gateway origin with the Sophos token."""
