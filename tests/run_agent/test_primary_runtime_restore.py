...
5. Recovery is skipped for aggregator providers (OpenRouter, Sophos)
...
def _make_agent(fallback_model=None, provider="custom", base_url="https://my-llm.example.com/v1"):
    ...
    with (
        ...
        # reachable hosts (the sophos portal case) the endpoint's answer for the
...
class TestTryRecoverPrimaryTransport:
    ...
    def test_allowed_for_sophos_anthropic_messages(self):
        ...
        agent._primary_runtime.update({
            ...
            "anthropic_base_url": "https://inference-api.sophostechne.com/v1",
