...
class TestQwenAlibabaFamily:
    ...
    def test_qwen_on_hackit_portal_caches_with_envelope_layout(self):
        # Hackit Portal Qwen takes the same envelope-layout cache_control
    ...
    def test_non_qwen_non_claude_on_hackit_portal_does_not_cache(self):
...
class TestHackitPortalAnthropicWire:
