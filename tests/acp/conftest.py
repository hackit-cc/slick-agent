...
Keeps the ACP server tests offline: ``SlickACPAgent._build_model_state``
calls ``slick_cli.inventory.build_models_payload``, which (without this
...
def _offline_model_inventory(monkeypatch):
    ...
    import slick_cli.inventory as inventory
