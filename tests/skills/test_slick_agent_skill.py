"""The `slick-agent` skill is what a running Slick knows about itself.

`website/` is never packaged, so an installed Slick has no local copy of the
user guide; skills ARE synced into `$SLICK_HOME/skills/`. The skill therefore
...
shipped feature is invisible and the agent answers "Slick can't do that."
"""
...
SKILL_DIR = REPO / "skills" / "autonomous-ai-agents" / "slick-agent"
