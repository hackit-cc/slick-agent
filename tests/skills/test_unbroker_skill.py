...
# Resolve the skill's scripts dir across layouts: standalone dev repo (tests/) and slick-agent
...
_CANDIDATES = [
    ...
    _HERE.parent.parent.parent.joinpath(*_REL),          # slick-agent (tests/skills/)
]
