...
class TestIsFreeTierModel:
    ...
    def test_pricing_cache_peek_zero_priced_model(self, monkeypatch):
        ...
        monkeypatch.setattr(
            ...
            "_pricing_cache",
            {
                "https://inference-api.sophostechne.com": {
                    "some/zero-priced": {"prompt": "0", "completion": "0"},
                    "some/paid": {"prompt": "0.000001", "completion": "0.000002"},
                }
            },
        )
        # The agent holds the /v1-suffixed URL (DEFAULT_SOPHOS_INFERENCE_URL) —
        # the helper must normalize it down to the picker's cache key.
        base = "https://inference-api.sophostechne.com/v1"
        ...
        assert is_free_tier_model("some/zero-priced", "https://inference-api.sophostechne.com/") is True
        assert is_free_tier_model("some/zero-priced", "https://inference-api.sophostechne.com/v1/") is True
    ...
    def test_exception_fails_open_to_false(self, monkeypatch):
        ...
        assert is_free_tier_model("some/model", "https://inference-api.sophostechne.com") is False
    ...
    def test_stealth_prefix_detected_as_free(self):
        ...
        assert is_free_tier_model("stealth/ox-alpha", "https://inference-api.sophostechne.com/v1") is True
