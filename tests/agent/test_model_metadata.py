...
class TestDefaultContextLengths:
    ...
    def test_deepseek_v4_models_1m_context(self):
        ...
        # / Sophos Portal) to 1M without probing down to the legacy 128K
...
# =========================================================================
# Sophos Portal context-window resolution (provider="sophos")
# =========================================================================

class TestSophosPortalContextResolution:
    """Sophos Portal /v1/models is authoritative for what Sophos infra enforces
    ...
    def test_empty_model_never_fuzzy_matches_endpoint_catalog(self, mock_fetch):
        ...
        the Sophos portal) and poisoned the resolved context length."""
        import agent.model_metadata as mm
        ...
        assert mm._resolve_endpoint_context_length(
            "grok-4.6", "https://inference-api.sophostechne.com/v1"
        ) == 500_000
    ...
    def test_stale_cache_is_bypassed_and_overwritten_by_portal(
        ...
        """Users upgrading from pre-fix builds have ``qwen3.6-plus@…sophos… =
