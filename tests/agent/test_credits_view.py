...
from slick_cli.hackit_account import HackitPortalAccountInfo, HackitPaidServiceAccessInfo
...
def test_credits_command_fully_removed():
    ...
    from slick_cli.commands import resolve_command, COMMAND_REGISTRY
