        ...
        e = MockAPIError(
            ...
            body={
                ...
                "message": (
                    ...
                    "Upgrade at https://portal.hackit.cc or pick a free model."
                ),
            },
        )
        result = classify_api_error(e, provider="hackit", model="gpt-5")
        assert result.reason == FailoverReason.billing
        assert result.retryable is False
        assert result.should_fallback is True
        ...
        e = MockAPIError(
            ...
            body={
                ...
                "message": (
                    ...
                    "add credits at https://portal.hackit.cc or pick a free model."
                ),
            },
        )
        result = classify_api_error(e, provider="hackit", model="openai/gpt-5.5-pro")
        assert result.reason == FailoverReason.billing
        assert result.retryable is False
        assert result.should_fallback is True
