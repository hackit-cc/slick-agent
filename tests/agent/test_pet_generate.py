...
def test_list_sprite_providers_marks_default(monkeypatch):
    ...
    registry = {"openai": _FakeImgProvider("openai"), "sophos": _FakeImgProvider("sophos")}
    ...
    # Listed in preference order: Sophos Portal before OpenAI.
    assert [p["name"] for p in listed] == ["sophos", "openai"]
