...
thinking phase.  Slick's default cloud-stream stale detector
(``SLICK_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``SLICK_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the
