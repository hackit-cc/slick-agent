...
Damien's incident (Discord, 2026-05-28): a long Slick session in a Discord
...
def _make_legacy_session_db_class() -> type:
    ...
    imports the same still-loaded ``slick_state`` module, whose ``SessionDB``
    ...
    namespace = {"__name__": "slick_state"}
    source = '''
class SessionDB:
...
_NominalSessionDBImpostor.__module__ = "slick_state"
