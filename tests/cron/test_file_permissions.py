...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("slick_cli.config.get_config_path", return_value=config_path), \
             patch("slick_cli.config.ensure_slick_home"):
    ...
    def test_ensure_slick_home_sets_0700(self):
        home = Path(self.tmpdir) / ".slick"
