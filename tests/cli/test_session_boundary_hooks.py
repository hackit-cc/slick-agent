...
from slick_cli.plugins import VALID_HOOKS, PluginManager
...
# tests/slick_cli/test_lifecycle.py::test_finalize_session_closes_core_before_plugin_export.
@patch("slick_cli.lifecycle.invoke_hook")
@patch("slick_cli.lifecycle.finalize_session")
