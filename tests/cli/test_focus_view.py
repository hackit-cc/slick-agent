...
class TestStatusBarSegment:
    ...
    def test_text_renderer_includes_the_badge_at_every_width_tier(self, width):
        ...
        host = SlickCLI.__new__(SlickCLI)
        host.model = "opus"
        ...
        with patch.object(SlickCLI, "_get_status_bar_snapshot", return_value=snapshot), \
             patch.object(SlickCLI, "_is_session_yolo_active", return_value=False):
            text = SlickCLI._build_status_bar_text(host, width=width)
