"""Regression test: slick update must not load cryptography eagerly."""
...
assert 'slick_cli.secrets_cli' not in sys.modules, \\
...
"""
    ...
    def test_update_check_no_cryptography(self) -> None:
        """Running slick update --check should NOT load cryptography._rust."""
        # Write a small script in the repo root so slick_cli is importable,
...
import slick_cli.main
from slick_cli.update_cmd import _cmd_update_check
