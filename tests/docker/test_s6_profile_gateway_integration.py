...
The unit tests in tests/slick_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned slick-writable by the
...
from slick_cli.service_manager import S6ServiceManager
