...
failed: Slick is not logged into Hackit Portal" on every message.
...
def test_e2e_login_then_supervised_gateway_can_read_auth(
    ...
    as a parse failure, and resolve_hackit_runtime_credentials raised
    "Slick is not logged into Hackit Portal" on every message.
