"""Session <-> workspace grouping key (slick_state.workspace_key).

The key is what `slick sessions list --workspace` groups/filters on. It is a
...
from slick_state import workspace_key
