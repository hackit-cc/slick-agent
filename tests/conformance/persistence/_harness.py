...
def make_slick_home(base: Path, journal_mode: str) -> Path:
    """Create an isolated SLICK_HOME whose config pins ``database.journal_mode``.
    ...
    """
    home = base / f"slick-home-{journal_mode}"
