...
#88532 made SessionStore follow SLICK_HOME; this covers the TUI/agent
...
def homes(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(slick_state, "DEFAULT_DB_PATH", slick_state._IMPORT_DEFAULT_DB_PATH)
    return root, profile
...
def test_open_profile_session_db_does_not_fallback_on_open_failure(homes, monkeypatch):
    ...
    monkeypatch.setattr("slick_state.SessionDB", boom_db)
