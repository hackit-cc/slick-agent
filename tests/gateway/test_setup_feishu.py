"""Tests for _setup_feishu() in slick_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("slick_cli.config.save_env_value", side_effect=mock_save), \
         patch("slick_cli.config.get_env_value", side_effect=mock_get), \
         patch("slick_cli.config.remove_env_value", side_effect=mock_remove), \
         patch("slick_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("slick_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("slick_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("slick_cli.cli_output.print_header"), \
         patch("slick_cli.cli_output.print_info"), \
         patch("slick_cli.cli_output.print_success"), \
         patch("slick_cli.cli_output.print_warning"), \
         patch("slick_cli.cli_output.print_error"), \
