"""Unit tests for the generic-OIDC / Sophos-Portal caller-identity token resolver.
...
Three modes:
  ...
  2. Sophos Portal (resolve_sophos_access_token) otherwise — the default.

The HTTP calls and the Sophos resolver are monkeypatched; these prove the mode
