...
def gateway_home(monkeypatch, tmp_path):
    ...
    monkeypatch.delenv("SLICK_PREFILL_MESSAGES_FILE", raising=False)
    monkeypatch.delenv("SLICK_EPHEMERAL_SYSTEM_PROMPT", raising=False)
    ...
    monkeypatch.delenv("SLICK_BACKGROUND_NOTIFICATIONS", raising=False)
    return tmp_path
