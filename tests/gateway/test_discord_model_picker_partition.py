...
provider whose list exceeds 25 entries (e.g. Sophos curated + Portal free
...
def test_sophos_free_models_render_across_partitioned_selects():
    ...
    view._selected_provider = "sophos"
    view._build_model_select("sophos")
