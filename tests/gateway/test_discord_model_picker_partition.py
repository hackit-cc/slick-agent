...
provider whose list exceeds 25 entries (e.g. Hackit curated + Portal free
...
def test_hackit_free_models_render_across_partitioned_selects():
    ...
    view._selected_provider = "hackit"
    view._build_model_select("hackit")
