...
def test_load_transcript_returns_db_messages_when_no_jsonl(tmp_path, monkeypatch):
    ...
    ~/.slick/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at slick_state import time, before pytest's SLICK_HOME monkeypatch
    fires — the autouse fixture's SLICK_HOME override doesn't help here.)
    """
    import slick_state
