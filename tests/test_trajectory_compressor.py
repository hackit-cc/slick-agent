...
def test_import_loads_env_from_slick_home(tmp_path, monkeypatch):
    home = tmp_path / ".slick"
    home.mkdir()
    (home / ".env").write_text("OPENROUTER_API_KEY=from-slick-home\n", encoding="utf-8")
    ...
    assert os.getenv("OPENROUTER_API_KEY") == "from-slick-home"
