...
class TestHackitProfileParity:
    def test_tags(self, transport):
        legacy = transport.build_kwargs(
            model="slick-3", messages=_msgs(), tools=None, provider_profile=get_provider_profile("hackit"),
        )
        profile = transport.build_kwargs(
            model="slick-3", messages=_msgs(), tools=None,
