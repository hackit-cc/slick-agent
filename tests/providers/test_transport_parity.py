...
class TestSophosParity:
    """Sophos: product tags, reasoning passthrough (disable included)."""

    def test_tags(self, transport):
        from agent.portal_tags import sophos_portal_tags
        kw = transport.build_kwargs(
            model="slick-3-llama-3.1-405b",
            messages=_simple_messages(),
            tools=None,
            provider_profile=get_provider_profile("sophos"),
        )
