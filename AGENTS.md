...
- **Third-party products / other people's projects integrated into the core
  ...
  **standalone plugin repo** users install into `~/.slick/plugins/` (or via a
  pip entry point), and promote them in the Sophos Techne Discord
...
don't own. Promote standalone plugins in the Sophos Techne Discord
...
[`slick-example-plugins`](https://github.com/SophosTechne/slick-example-plugins)
