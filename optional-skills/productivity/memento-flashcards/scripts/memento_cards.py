...
Data file: $SLICK_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_SLICK_HOME = Path(os.environ.get("SLICK_HOME", Path.home() / ".slick"))
DATA_DIR = _SLICK_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
