...
def _state_dir() -> Path:
    ...
    # Default: $SLICK_HOME/watcher-state/, falling back to ~/.slick/watcher-state/.
    slick_home = os.environ.get("SLICK_HOME") or str(Path.home() / ".slick")
    return Path(slick_home) / "watcher-state"
