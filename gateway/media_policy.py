...
from environment variables:
  ...
  - ``SLICK_MEDIA_DELIVERY_STRICT``    <- gateway.strict
  - ``SLICK_MEDIA_ALLOW_DIRS``         <- gateway.media_delivery_allow_dirs
  - ``SLICK_MEDIA_TRUST_RECENT_FILES`` <- gateway.trust_recent_files
...
gateway — a manual ``slick cron run`` in the CLI, ``slick send``, a
...
_STRICT_ENV = "SLICK_MEDIA_DELIVERY_STRICT"
_ALLOW_DIRS_ENV = "SLICK_MEDIA_ALLOW_DIRS"
_TRUST_RECENT_ENV = "SLICK_MEDIA_TRUST_RECENT_FILES"
