...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {"name": "reset", "description": "Reset your Slick session"},
        {
            "name": "model",
        ...
        {"name": "status", "description": "Show Slick session status"},
        {"name": "sethome", "description": "Set this chat as the home channel"},
        {"name": "stop", "description": "Stop the running Slick agent"},
        {
            "name": "steer",
        ...
        {"name": "update", "description": "Update Slick Agent to the latest version"},
        {"name": "restart", "description": "Gracefully restart the Slick gateway"},
        {
            "name": "approve",
        ...
        {
            "name": "thread",
            "description": "Create a new thread and start a Slick session in it",
