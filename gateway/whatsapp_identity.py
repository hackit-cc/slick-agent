...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$SLICK_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_slick_dir("platforms/whatsapp/session", "whatsapp/session")
