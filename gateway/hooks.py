...
Hooks are discovered from ~/.slick/hooks/ directories, each containing:
...
HOOKS_DIR = get_slick_home() / "hooks"
    ...
    def discover_and_load(self) -> None:
        ...
        for hook_dir in sorted(HOOKS_DIR.iterdir()):
            ...
            try:
                ...
                module_name = f"slick_hook_{hook_name}"
