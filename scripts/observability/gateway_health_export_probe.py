...
def main() -> None:
    ...
    slick_home = Path(tempfile.mkdtemp(prefix="slick-otel-smoke-"))
    ...
    config = {
        "monitoring": {
            ...
            "gateway_health_export": {
                ...
                "resource_attributes": {
                    "service.name": "slick-gateway-smoke",
    ...
    print(json.dumps({"slick_home": str(slick_home), "requests": len(rows), "paths": sorted(paths)}, indent=2))
