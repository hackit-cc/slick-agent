#!/usr/bin/env python3
"""Build the Slick Skills Index — a centralized JSON catalog of all skills.
...
`slick skills search/install` can use it without hitting the GitHub API.
...
# Ensure SLICK_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Slick Skills Index...", flush=True)
