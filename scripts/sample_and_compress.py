...
DEFAULT_DATASETS = [
    "SophosTechne/swe-terminus-agent-glm-kimi-minimax",
    "SophosTechne/slick-agent-megascience-sft1",
    "SophosTechne/Slick-Agent-Thinking-GLM-4.7-SFT2",
    "SophosTechne/Slick-Agent-Thinking-GLM-4.7-SFT1",
    "SophosTechne/terminal-tasks-glm-slick-agent"
]
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "SophosTechne/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload SophosTechne/{output_name} {final_output}")
