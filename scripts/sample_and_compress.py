...
DEFAULT_DATASETS = [
    "Hackit/swe-terminus-agent-glm-kimi-minimax",
    "Hackit/slick-agent-megascience-sft1",
    "Hackit/Slick-Agent-Thinking-GLM-4.7-SFT2",
    "Hackit/Slick-Agent-Thinking-GLM-4.7-SFT1",
    "Hackit/terminal-tasks-glm-slick-agent"
]
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "Hackit/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload Hackit/{output_name} {final_output}")
