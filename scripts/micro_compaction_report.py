#!/usr/bin/env python3
"""Summarize micro-compaction telemetry from Slick logs.
...
With no LOGFILE, reads ``$SLICK_HOME/logs/agent.log`` (default ~/.slick).
...
def default_log() -> Path:
    home = os.environ.get("SLICK_HOME") or str(Path.home() / ".slick")
