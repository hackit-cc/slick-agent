...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^Slick\s+(Agent|Audit)$", re.IGNORECASE),
    re.compile(r"^sophosbot(-eng)?$", re.IGNORECASE),
    ...
    re.compile(r".*\[bot\]$", re.IGNORECASE),             # any GitHub [bot] suffix (slick-seaeye[bot] etc.)
...
IGNORED_EMAILS = {
    ...
    "noreply@github.com",
    "noreply@sophostechne.com",
    "cursoragent@cursor.com",
    "slick@sophostechne.com",
    "slick-audit@example.com",
    "sophosbot@sophostechne.com",
    "slick@habibilabs.dev",
    "omx@oh-my-codex.dev",
    "codex@openai.com",
