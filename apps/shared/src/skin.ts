/**
 * Canonical Slick skin — the theme SDK's cross-surface contract.
 *
 * A skin is authored once as YAML in `$SLICK_HOME/skins/<name>.yaml` (or a
 * built-in), resolved by the Python skin engine (`slick_cli/skin_engine.py`),
 ...
 *   • CLI     → `slick_cli/skin_engine` → prompt_toolkit / Rich styles (Python)
 *
