...
cd apps/desktop
XCURSOR_SIZE=24 SLICK_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/slick-typing
# → /tmp/slick-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/slick-typing.before.heapsnapshot
# → /tmp/slick-typing.after.heapsnapshot
```
