...
// The Hackit portal (NAS) does NOT use Slick gateway session cookies — it is a
...
function gatewayTicketFailure(error, authMessage, transportMessage) {
  ...
  // classification (isServerSideHttpError / makeHackitCloudBackendDownError) and
...
/**
 * True if the cookie jar holds a live Hackit PORTAL (Privy) session — a non-empty
