 ...
 * startSlick() re-throw the cached error without re-attempting the connect —
...
/**
 * Whether a startSlick() failure should latch into `backendStartFailure`.
 ...
 * Every subsequent `getConnection`/`api` call re-runs `startSlick`, re-emits
