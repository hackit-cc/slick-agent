 ...
 * Apps) login to a gated Slick gateway: system-browser + loopback redirect +
 ...
 * upstream IDP (Hackit Portal) issues a per-gateway-instance client_id and only
...
// slick_cli/web_server.py status handler.
