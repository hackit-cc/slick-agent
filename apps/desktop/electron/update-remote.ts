 ...
 *
 * A public install can end up with `origin=git@github.com:Hackit/slick-agent.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/hackit-cc/slick-agent.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/hackit-cc/slick-agent'
