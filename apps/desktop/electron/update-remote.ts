 ...
 *
 * A public install can end up with `origin=git@github.com:SophosTechne/slick-agent.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/SophosTechne/slick-agent.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/sophostechne/slick-agent'
