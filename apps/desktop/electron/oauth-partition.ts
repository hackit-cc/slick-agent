 ...
 * (`persist:slick-remote-oauth`) — the jar was keyed on the auth *mode*, not
 ...
 * setup: one box, two dashboards) fought over the same `slick_session*`
 ...
 *     cascade deliberately shares one jar with the Hackit Portal session.
...
export const LEGACY_OAUTH_PARTITION = 'persist:slick-remote-oauth'
