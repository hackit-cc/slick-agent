...
// by main.ts (`setBackgroundThrottling` driven by the merged `slick:active-work`
...
// (the "Slick idles at 20% CPU while minimized" bug). The preload path is
...
// conversation started by the "Hey Slick" wake word has NO preceding click,
