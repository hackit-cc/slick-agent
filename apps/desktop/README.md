...
<p align="center">
  <a href="https://github.com/hackit-cc/slick-agent/releases"><img src="https://img.shields.io/badge/Download-macOS%20%C2%B7%20Windows%20%C2%B7%20Linux-FFD700?style=for-the-badge" alt="Download"></a>
...
**The native desktop app for [Slick Agent](../../README.md) — the self-improving AI agent from [Hackit](https://hackit.cc).** Same agent, same skills, same memory as the CLI and gateway, in a polished native window — chat with streaming tool output, side-by-side previews, a file browser, voice, and settings, no terminal required. Available for **macOS, Windows, and Linux**.
...
Prebuilt installers are built and distributed via [the Slick Desktop website.](https://slick-agent.hackit.cc/).
...
- 📖 [Documentation](https://slick-agent.hackit.cc/docs/)
