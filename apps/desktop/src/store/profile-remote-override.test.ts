...
describe('remoteHostLabel', () => {
  it('keeps a non-default port and drops default ones', () => {
    expect(remoteHostLabel('https://slick.example.com:8443/x')).toBe('slick.example.com:8443')
    expect(remoteHostLabel('https://slick.example.com:443')).toBe('slick.example.com')
    expect(remoteHostLabel('http://slick.example.com:80')).toBe('slick.example.com')
  })
