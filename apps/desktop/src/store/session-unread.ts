...
function rehydrateFromDiskOnce(): void {
  ...
  try {
    const rawSeen = readKey('slick.desktop.sessionSeenCounts')
    ...
    const rawMarkers = readKey('slick.desktop.unreadFinishedSessions')
