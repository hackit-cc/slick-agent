...
function identityForConnection(connection: SlickConnection | null): string {
  if (!connection) {
    return ''
  }
...
export function syncCronModelImpactConnection(connection: SlickConnection | null): void {
