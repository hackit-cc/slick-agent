...
const POPOUT_STORAGE_KEY = 'slick.desktop.composerPopout.zones.v1'
const POPOUT_GESTURES_ENABLED_STORAGE_KEY = 'slick.desktop.composerPopout.gesturesEnabled'
...
const LEGACY_ENABLED_KEY = 'slick.desktop.composerPopout.enabled'
const LEGACY_POSITION_KEY = 'slick.desktop.composerPopout.position'
