...
function installBridge(
  openSessionWindow?: Window['slickDesktop']['openSessionWindow'],
  openWindow?: Window['slickDesktop']['openWindow'],
  openBrowserWindow?: Window['slickDesktop']['openBrowserWindow']
) {
