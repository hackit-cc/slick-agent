...
export interface PetInfo {
  ...
  // the Slick "run" activity state uses the in-place running row).
 ...
 * SLICK_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'slick.desktop.pet-roam.v1'
