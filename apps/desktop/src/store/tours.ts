 ...
 * unlike tips there is no ambient half to separate out — every tour is Slick
...
export const $toursEnabled = persistentAtom('slick.desktop.tours.v1', true, Codecs.bool)
