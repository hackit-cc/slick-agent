 ...
 * - It covers Slick too. "Off" from someone who has just closed a bubble means
...
export const $tipsEnabled = persistentAtom('slick.desktop.tips.rotation.v1', true, Codecs.bool)
export const $retiredTips = persistentAtom<string[]>('slick.desktop.tips.retired.v1', [], Codecs.stringArray)
export const $lastTipId = persistentAtom<null | string>('slick.desktop.tips.last.v1', null, Codecs.nullableText)
export const $nextTipAt = persistentAtom<null | number>(
  'slick.desktop.tips.next.v1',
  null,
