...
export const en: Translations = {
  ...
  boot: {
    ...
    failure: {
      ...
      cloudDownTitle: 'Hackit Cloud agent is down',
      cloudDownDescription:
        'The Hackit-managed cloud agent this gateway connects to is returning a server error. It cannot be restarted from here — check its status, switch to the local gateway, or get support.',
      cloudDownHint:
        'The buttons below open the Hackit Portal (instance status and controls) and our Discord for support.',
  ...
  billingBlock: {
    titleHackit: 'Out of Hackit credits',
  ...
  sendDiagnostics: {
    title: 'Send diagnostics to Hackit',
    privacyNotice:
      'This uploads a debug bundle to Hackit-internal storage (not a public paste). It includes system info (OS, versions, provider, which API keys are configured — never the keys themselves) and full agent, gateway, and desktop logs (up to 512 KB each), which likely contain conversation content, tool outputs, and file paths. Secrets are redacted before upload. The bundle is viewable only by Hackit staff and allowlisted Discord moderators, and auto-deletes after 14 days.',
    upload: 'Upload',
    uploading: 'Uploading…',
    cancel: 'Cancel',
    close: 'Close',
    ...
    failedHint:
      'You can also run `slick debug share --hackit` from a terminal, or `slick debug share --local` to print the report without uploading.',
    handoffLead: 'Pick up the discussion in:',
    links: {
      github: 'GitHub Issues',
      portal: 'Hackit Portal Support',
      discord: 'Discord'
    }
  },
  ...
  settings: {
    ...
    gateway: {
      ...
      sshErrNotInstalled:
        'Slick is not installed on the remote host. Install it there (curl -fsSL https://slick-agent.hackit.cc/install.sh | sh) or set the Slick path.',
      sshErrPlatform:
    ...
    toolsets: {
      ...
      hackitIncluded: 'Included with a Hackit subscription — sign in to Hackit Portal to activate.',
      hackitAuthNeededTitle: 'Sign in to Hackit Portal',
      hackitAuthNeededMessage: provider => `${provider} is saved but won't activate until you sign in to Hackit Portal.`,
      hackitAuthSignIn: 'Sign in',
      hackitAuthDoneTitle: 'Hackit Portal connected',
      hackitAuthDoneMessage: 'Your subscription backends are now active.',
      hackitAuthFailed: 'Hackit Portal sign-in did not complete',
  ...
  modelPicker: {
    ...
    pro: 'Pro',
    proNeedsSubscription: 'Pro models need a paid Hackit subscription.',
    free: 'Free',
    freeTier: 'Free tier',
  ...
  assistant: {
    ...
    mcpSetup: {
      ...
      catalogSource: 'From the Hackit-approved catalog',
