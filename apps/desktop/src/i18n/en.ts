...
export const en: Translations = {
  ...
  boot: {
    ready: 'Slick Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Slick settings',
      loadingSessions: 'Loading recent sessions',
      retryingRemoteBackend: 'Reconnecting to the remote Slick backend…',
      startingDesktopConnection: 'Starting desktop connection',
      startingSlickDesktop: 'Starting Slick Desktop…'
    },
    errors: {
      backgroundExited: 'Slick background process exited.',
      backgroundExitedDuringStartup: 'Slick background process exited during startup.',
    ...
    failure: {
      ...
      cloudDownTitle: 'Sophos Cloud agent is down',
      cloudDownDescription:
        'The Sophos-managed cloud agent this gateway connects to is returning a server error. It cannot be restarted from here — check its status, switch to the local gateway, or get support.',
      cloudDownHint:
        'The buttons below open the Sophos Portal (instance status and controls) and our Discord for support.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Slick backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateSlick: 'Update Slick',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Slick Desktop.',
    ...
    native: {
      ...
      inputBody: 'Slick is waiting for your response.',
      turnDoneTitle: 'Slick finished',
      turnDoneBody: '',
  ...
  billingBlock: {
    titleSophos: 'Out of Sophos credits',
  ...
  sendDiagnostics: {
    title: 'Send diagnostics to Sophos',
    privacyNotice:
      'This uploads a debug bundle to Sophos-internal storage (not a public paste). It includes system info (OS, versions, provider, which API keys are configured — never the keys themselves) and full agent, gateway, and desktop logs (up to 512 KB each), which likely contain conversation content, tool outputs, and file paths. Secrets are redacted before upload. The bundle is viewable only by Sophos staff and allowlisted Discord moderators, and auto-deletes after 14 days.',
    upload: 'Upload',
    uploading: 'Uploading…',
    cancel: 'Cancel',
    close: 'Close',
    ...
    failedHint:
      'You can also run `slick debug share --sophos` from a terminal, or `slick debug share --local` to print the report without uploading.',
    handoffLead: 'Pick up the discussion in:',
    links: {
      github: 'GitHub Issues',
      portal: 'Sophos Portal Support',
      discord: 'Discord'
    }
  },
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Slick defaults?',
    ...
    plugins: {
      ...
      agent: {
        title: 'Agent plugins',
        blurb:
          'Plugins you installed into the Slick backend — tools, skills, MCP servers, hooks, and slash commands. Portable ones are Agent Plugins packages (skills + MCP bundles that work in other agents too). Toggles apply to new sessions.',
        ...
        updateBackendToManage: 'Update the Slick backend to manage this plugin from Desktop.',
      ...
      installModal: {
        ...
        agentTargetLocal: profile => `Installs into the ${profile} backend (~/.slick/plugins/)`,
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Slick is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Slick asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Slick was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while Slick was in the background.'
        }
      },
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Slick follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and Slick can react to yours.',
      tipsTitle: 'In-App Tips',
      tipsDesc:
        'A small bubble pointing at one part of the app, shown occasionally while idle and by Slick when it helps. Closing one retires it for good.',
      tipsReset: (count: number) => `Bring back ${count} closed ${count === 1 ? 'tip' : 'tips'}`,
      toursTitle: 'Guided Tours',
      toursDesc: 'Let Slick walk you through the app, dimming the screen and spotlighting each step.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Slick is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Slick, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      heading: 'Slick Desktop',
      version: value => `Version ${value}`,
      versionUnavailable: 'Version unavailable',
      bundleOutOfSync: 'App build out of date',
      bundleOutOfSyncDesc:
        'The Slick runtime was updated, but the desktop app itself is still an older build — new interface features (like Bot Mode) will be missing until it updates. Run the update below to rebuild the app. If that doesn\u2019t clear this warning, reinstall from the latest desktop installer.',
      ...
      automaticUpdatesDesc:
        'Slick checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Slick configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening Slick.',
    ...
    connections: {
      ...
      intro: 'Manage this device and every Slick gateway it can reach through remote, SSH, or Cloud connections.',
      stagedNote:
      ...
      updateSkippedCloud: 'Managed by Slick Cloud',
      kindLocal: 'Local',
      kindRemote: 'Remote gateway',
      kindCloud: 'Slick Cloud',
      kindSsh: 'SSH',
      kindLocalDesc: 'The Slick runtime managed by this app.',
      kindRemoteDesc: 'A Slick gateway reachable over HTTP(S) — LAN, Tailscale, or the internet.',
      kindCloudDesc: 'A hosted instance discovered through your Slick Cloud account.',
      kindSshDesc: 'A Slick install reached over SSH.',
      labelTitle: 'Name',
      ...
      headersDesc:
        'Sent with every HTTP and WebSocket request to this gateway — for access proxies such as Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Values are stored encrypted. Headers Slick manages (Authorization, Cookie, Host…) are ignored.',
      ...
      cloudAddHint:
        'Tip: signing in under Slick Cloud above discovers your agents automatically — use this form only to register a known instance URL by hand.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a Slick backend elsewhere. Gateway connections are machine-level; profiles are discovered from the gateways you connect.',
      envOverrideTitle: 'Environment variables are controlling this desktop session.',
      envOverrideDesc:
        'Unset SLICK_DESKTOP_REMOTE_URL and SLICK_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      modeTitle: 'Connection mode',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Slick backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Slick backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Slick Cloud',
      cloudDesc: 'Sign in once to Slick Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Slick Cloud',
      cloudSignIn: 'Sign in to Slick Cloud',
      cloudSignedIn: 'Signed in to Slick Cloud',
      cloudNeedsSignIn: 'Sign in to Slick Cloud to discover the agents on your account.',
      ...
      cloudNoAgents: {
        ...
        linkText: 'Sophos portal',
        after: ', then refresh.'
      },
      cloudRefresh: 'Refresh',
      cloudConnect: 'Connect',
      cloudConnecting: 'Connecting…',
      cloudDiscoverFailed: 'Could not load your Slick Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Slick Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Slick Cloud',
      cloudSignedOutMessage: 'Cleared the Slick Cloud session.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /slick.',
      ...
      restartingMessage: 'Slick Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Slick ${version}` : ''}`,
      ...
      sshDesc:
        'Slick is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshSlickPathTitle: 'Slick path (optional)',
      sshSlickPathDesc: 'Full path to the remote slick binary. Blank = auto-detect.',
      sshSlickPathPlaceholder: 'auto-detect',
      sshTestConnection: 'Test SSH',
      sshConnect: 'Connect',
      sshButtonsHint: 'Save applies on the next launch. Connect reconnects now.',
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Slick found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Slick runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'Slick is not installed on the remote host. Install it there (curl -fsSL https://slick-agent.sophostechne.com/install.sh | sh) or set the Slick path.',
      sshErrPlatform:
        'Unsupported remote platform. Slick Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update Slick on the remote host before connecting with Desktop SSH.',
    ...
    mcp: {
      ...
      deepLinkDescription:
        'A link asked to add this MCP server to Slick. Review the exact configuration below — it comes from the link, not from Slick.',
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Slick runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point Slick at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
    ...
    toolsets: {
      ...
      sophosIncluded: 'Included with a Sophos subscription — sign in to Sophos Portal to activate.',
      sophosAuthNeededTitle: 'Sign in to Sophos Portal',
      sophosAuthNeededMessage: provider => `${provider} is saved but won't activate until you sign in to Sophos Portal.`,
      sophosAuthSignIn: 'Sign in',
      sophosAuthDoneTitle: 'Sophos Portal connected',
      sophosAuthDoneMessage: 'Your subscription backends are now active.',
      sophosAuthFailed: 'Sophos Portal sign-in did not complete',
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via slick curator restore.',
    hub: {
  ...
  starmap: {
    ...
    emptyDesc: 'As Slick builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Slick to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Slick to generate pets.',
      backgroundHint: 'You can close this — Slick will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Slick desktop' },
    ...
    slickActiveSessions: (version, count) => `Slick ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@slick:example.org' },
  ...
  profiles: {
    ...
    remoteOverride: {
      ...
      description: 'Sessions in this profile will run on the remote Slick you point it at, instead of this computer.',
      urlLabel: 'Remote address',
      urlPlaceholder: 'https://slick.example.com',
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Slick environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    modelImpact: {
      ...
      saveFailed: 'Slick did not save that model change.',
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Slick will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Slick backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Slick. Files, git repos, and worktrees stay untouched.',
      ...
      worktreeStaleBackend:
        'Update the Slick backend to create worktrees over this remote connection — it predates the git worktree API.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Slick...',
    placeholderReconnecting: 'Reconnecting to Slick…',
    ...
    attachUrlDesc: 'Slick will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Slick to open PR',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Slick…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Slick…',
    ...
    unsupportedMessage: 'This version of Slick can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Slick from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Slick will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Slick desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Slick updater takes over in its own window and reopens Slick automatically when it’s done. Please don’t reopen Slick yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Slick reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Slick reopens on its own.',
    errorTitle: 'Update didn’t finish',
    errorBody: 'No worries — nothing was lost. You can try again now.',
    blockerTitle: 'Close local previews to update Slick?',
    blockerBody:
      'Slick needs to stop these local previews before updating. This will not modify or delete your files.',
    foreignBlockerTitle: 'Close other processes to update Slick',
    foreignBlockerBody:
      'Slick can’t safely close these processes automatically. Close the app, terminal, or service that owns each one, then try the update again.',
    mixedBlockerBody:
      'Slick can close the local previews listed below. Other processes must be closed manually before the update can continue.',
  ...
  install: {
    ...
    oneTimeTitle: 'Slick needs a one-time install',
    ...
    setupChoiceTitle: 'Set up Slick Desktop',
    setupChoiceDesc:
      'Connect this app to a Slick gateway you already run, or install Slick locally on this computer.',
    connectExistingTitle: 'Connect to existing Slick',
    ...
    installLocalTitle: 'Install Slick locally',
    installLocalDesc: 'Download Slick, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart Slick Desktop and try again.',
    remoteSetupTitle: 'Connect to existing Slick',
    remoteSetupDesc: 'Enter your gateway URL. Slick Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the Slick gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/slick',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that Slick gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up Slick Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Slick CLI or desktop instance is running. Stop any running Slick instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Slick Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Slick is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Slick…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Slick',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Slick at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Slick connects automatically',
    ...
    authorizeThere: 'Authorize Slick there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Slick there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  modelPicker: {
    ...
    pro: 'Pro',
    proNeedsSubscription: 'Pro models need a paid Sophos subscription.',
    free: 'Free',
    freeTier: 'Free tier',
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Slick Desktop v${version}`,
      backendVersion: version => `Backend v${version}`,
      clientLabel: version => `client v${version}`,
      connectionSsh: host => `SSH: ${host}`,
      connectionRemote: host => `Remote: ${host}`,
      connectionCloud: host => `Cloud: ${host}`,
      connectionCloudTooltip: host => `Slick Cloud · ${host}`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Slick will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Slick is restarting...',
      askRestart: 'Ask Slick to restart the server',
      lookingRestart: taskId => `Slick is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Slick is working in the background. Watch the preview console for progress.',
      ...
      blankPageBody: 'Type an address above to browse, or ask Slick to open a page.',
      finishedRestarting: message => `Slick finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Slick could not restart the server.',
      stillWorking:
        'Slick is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Slick is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Slick gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.slick/config.yaml). Slick won’t ask again for commands like this — in this session or any future one.`,
    ...
    mcpSetup: {
      ...
      catalogSource: 'From the Sophos-approved catalog',
  ...
  prompts: {
    ...
    sudoDesc: 'Slick needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Slick needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Slick Desktop to use Save Image.',
    restartToSaveImages: 'Restart Slick Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `slick gateway` running?'
    }
  },
  ...
  tips: {
    ...
    items: {
      ...
      skills: {
        title: 'Teach it once',
        text: 'Skills are folders of instructions Slick loads when the work calls for them.'
      },
      messaging: {
        title: 'Slick away from your desk',
        text: 'Connect Telegram, Discord, Slack and more — same agent, same memory.'
      },
      artifacts: {
        title: 'Everything Slick made',
      ...
      profiles: {
        ...
        text: 'Each one is its own Slick — own keys, own memory, own sessions.'
      },
      'composer-mentions': {
