...
export interface Translations {
  ...
  settings: {
    ...
    toolsets: {
      ...
      useBackend: string
      sophosIncluded: string
      sophosAuthNeededTitle: string
      sophosAuthNeededMessage: (provider: string) => string
      sophosAuthSignIn: string
      sophosAuthDoneTitle: string
      sophosAuthDoneMessage: string
      sophosAuthFailed: string
