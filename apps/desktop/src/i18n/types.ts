...
export interface Translations {
  ...
  settings: {
    ...
    gateway: {
      ...
      sshKeyTitle: string
      sshKeyDesc: string
      sshSlickPathTitle: string
      sshSlickPathDesc: string
      sshSlickPathPlaceholder: string
    ...
    toolsets: {
      ...
      useBackend: string
      hackitIncluded: string
      hackitAuthNeededTitle: string
      hackitAuthNeededMessage: (provider: string) => string
      hackitAuthSignIn: string
      hackitAuthDoneTitle: string
      hackitAuthDoneMessage: string
      hackitAuthFailed: string
  ...
  commandCenter: {
    ...
    slickActiveSessions: (version: string, count: number) => string
