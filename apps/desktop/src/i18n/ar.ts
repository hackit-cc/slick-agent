...
export const ar = defineLocale({
  sendDiagnostics: {
    ...
    failedHint:
      'يمكنك أيضاً تشغيل `slick debug share --hackit` من الطرفية، أو `slick debug share --local` لعرض التقرير دون رفعه.',
    handoffLead: 'تابع النقاش في:',
    links: {
      github: 'GitHub Issues',
      portal: 'دعم بوابة Hackit',
      discord: 'Discord'
    }
  },
  common: {
  ...
  boot: {
    ...
    failure: {
      ...
      cloudDownTitle: 'عامل Hackit Cloud معطّل',
      cloudDownDescription:
        'يعيد عامل السحابة المُدار من Hackit الذي يتصل به هذا البوابة خطأً من الخادم. لا يمكن إعادة تشغيله من هنا — تحقق من حالته، أو بدّل إلى البوابة المحلية، أو احصل على الدعم.',
      cloudDownHint: 'تفتح الأزرار أدناه بوابة Hackit (حالة المثيل وعناصر التحكم) أو Discord للحصول على الدعم.',
  ...
  settings: {
    ...
    toolsets: {
      ...
      ready: 'جاهز',
      hackitIncluded: 'مُضمّن مع اشتراك Hackit — سجّل الدخول إلى Hackit Portal للتفعيل.',
