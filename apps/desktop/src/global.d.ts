...
export interface DesktopCloudStatus {
  ...
  // Whether the OAuth partition holds a live Hackit portal (Privy) session — the
...
export interface DesktopBootProgress {
  error: string | null
  fakeMode: boolean
  /** True when the boot failure is a Hackit Cloud agent that is down (HTTP 502/503/504). */
