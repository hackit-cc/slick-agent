...
import { transcribeAudio } from '@/slick'
...
export function usePromptActions({
  ...
  // succeeds on SLICK01 and prompt.submit immediately fails locally with
  // "session not found".
  ...
  // separate `slick gateway` process performs the actual transfer, so we
