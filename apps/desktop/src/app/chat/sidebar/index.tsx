...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/slick'
...
// highlight markers (sqlite snippet() delimiters — see slick_state_search.py).
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('slick:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('slick:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
  ...
  // A turn can `git worktree add/remove` in the terminal (e.g. you ask Slick to
