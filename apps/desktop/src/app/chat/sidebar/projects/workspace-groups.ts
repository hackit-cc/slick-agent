...
import type { ProjectInfo, SessionInfo } from '@/slick'
 ...
 * repo shows its branches/worktrees even when they have no Slick sessions yet.
...
export function mergeRepoWorktreeGroups(
  ...
  discoveredWorktrees?: SlickGitWorktree[]
): SidebarSessionGroup[] {
