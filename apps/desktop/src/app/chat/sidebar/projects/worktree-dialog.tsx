...
import type { SlickGitBranch } from '@/global'
...
const branchActionLabel = (branch: SlickGitBranch, copy: BranchActionCopy) => {
...
export function WorktreeDialog() {
  ...
  const [branches, setBranches] = useState<SlickGitBranch[]>([])
  ...
  const convert = async (branch: SlickGitBranch) => {
    if (pending || !repoPath || !branch) {
      return
    }
