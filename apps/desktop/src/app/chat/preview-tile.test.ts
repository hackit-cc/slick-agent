...
describe('browserTabLabel', () => {
  ...
  it('names an unreported tab from its target', () => {
    expect(browserTabLabel({ ...target, url: 'https://github.com/hackit' })).toBe('github.com')
  })
})
...
describe('browserTabExternalUrl', () => {
  ...
  it('falls back to the target when the tab has not reported a page yet', () => {
    expect(browserTabExternalUrl(openBrowser('https://github.com/hackit'))).toBe('https://github.com/hackit')
  })
