...
describe('browserTabLabel', () => {
  ...
  it('names an unreported tab from its target', () => {
    expect(browserTabLabel({ ...target, url: 'https://github.com/sophos' })).toBe('github.com')
  })
})
...
describe('browserTabExternalUrl', () => {
  ...
  it('falls back to the target when the tab has not reported a page yet', () => {
    expect(browserTabExternalUrl(openBrowser('https://github.com/sophos'))).toBe('https://github.com/sophos')
  })
