...
const FOCUS_EVENT = 'slick:composer-focus'
const INSERT_EVENT = 'slick:composer-insert'
const ATTACH_IMAGES_EVENT = 'slick:composer-attach-images'
const INSERT_REFS_EVENT = 'slick:composer-insert-refs'
const SUBMIT_EVENT = 'slick:composer-submit'
const VOICE_TOGGLE_EVENT = 'slick:composer-voice-toggle'
const MODEL_MENU_EVENT = 'slick:composer-model-menu'
