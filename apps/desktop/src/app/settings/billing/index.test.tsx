...
describe('BillingSettings', () => {
  ...
  it('renders logged-out as a connect card without normal account rows', async () => {
    ...
    expect(await screen.findByText('Connect your Hackit account')).toBeTruthy()
    expect(screen.getByText('Run /portal in the TUI or open the Hackit portal to connect your account.')).toBeTruthy()
