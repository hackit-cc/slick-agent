...
describe('BillingSettings', () => {
  ...
  it('renders logged-out as a connect card without normal account rows', async () => {
    ...
    expect(await screen.findByText('Connect your Sophos account')).toBeTruthy()
    expect(screen.getByText('Run /portal in the TUI or open the Sophos portal to connect your account.')).toBeTruthy()
