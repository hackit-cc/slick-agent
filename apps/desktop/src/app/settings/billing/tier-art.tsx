...
// over a solid Sophos-blue well and blends into it. This blue well is the ONLY place
// Sophos blue appears in the billing page — everything else stays on the app's own tokens.
const SOPHOS_BLUE = '#0000f2'
...
/**
 * Small rounded thumbnail (~40px) rendering the tier art over a Sophos-blue well.
...
export function TierArt({ className, name, size = 40 }: { className?: string; name?: null | string; size?: number }) {
  ...
  return (
    <div
      ...
      style={{ background: SOPHOS_BLUE, height: size, width: size }}
    >
      <img
        alt=""
