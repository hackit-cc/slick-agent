...
// over a solid Hackit-blue well and blends into it. This blue well is the ONLY place
// Hackit blue appears in the billing page — everything else stays on the app's own tokens.
const HACKIT_BLUE = '#0000f2'
...
/**
 * Small rounded thumbnail (~40px) rendering the tier art over a Hackit-blue well.
...
export function TierArt({ className, name, size = 40 }: { className?: string; name?: null | string; size?: number }) {
  ...
  return (
    <div
      ...
      style={{ background: HACKIT_BLUE, height: size, width: size }}
    >
      <img
        alt=""
