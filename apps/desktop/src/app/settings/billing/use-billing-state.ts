...
export const FALLBACK_PORTAL_BILLING_URL = 'https://portal.sophostechne.com/billing'
export const FALLBACK_PORTAL_URL = 'https://portal.sophostechne.com'

// The billing endpoint is the authoritative source of truth for balance / cap /
// plan — the inference `x-sophos-credits-*` headers are best-effort and can drift
  ...
  if (!billing.logged_in || subscription?.logged_in === false) {
    return {
      notice: {
        ...
        message: 'Run /portal in the TUI or open the Sophos portal to connect your account.',
