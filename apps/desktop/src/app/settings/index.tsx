...
import { getSlickConfigDefaults, getSlickConfigRecord, saveSlickConfig } from '@/slick'
...
export function SettingsView({ onClose, onConfigSaved, onMainModelChanged }: SettingsPageProps) {
  ...
  const exportConfig = async () => {
    try {
      const cfg = await getSlickConfigRecord()
  ...
  const resetConfig = async () => {
    ...
    try {
      await saveSlickConfig(await getSlickConfigDefaults())
      triggerHaptic('success')
      onConfigSaved?.()
    } catch (err) {
