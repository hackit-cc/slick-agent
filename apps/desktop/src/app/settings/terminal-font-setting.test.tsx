...
vi.mock('@/slick', () => ({
  saveSlickConfig: (config: Record<string, unknown>) => mocks.save(config)
}))
...
vi.mock('../hooks/use-config-record', () => ({
  setSlickConfigCache: (config: Record<string, unknown>) => mocks.cache(config),
  useSlickConfigRecord: () => ({ data: mocks.loadedConfig })
}))
