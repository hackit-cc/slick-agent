...
import type { ConfigFieldSchema, SlickConfigRecord, ToolsetInfo } from '@/types/slick'
...
export function getNested(obj: SlickConfigRecord, path: string): unknown {
  let cur: unknown = obj
 ...
 */
export function clearsEnabledToolsets(prev: SlickConfigRecord, next: SlickConfigRecord): boolean {
...
export function voiceFieldVisible(key: string, config: SlickConfigRecord): boolean {
...
export function setNested(obj: SlickConfigRecord, path: string, value: unknown): SlickConfigRecord {
...
function personalityOptions(config: SlickConfigRecord): string[] {
...
function commandProviderNames(config: SlickConfigRecord, section: 'tts' | 'stt'): string[] {
