...
import type { SlickConfigRecord, SessionInfo } from '@/types/slick'
...
// / Program Files), which buried any files Slick wrote there.
function DefaultProjectDirSetting() {
  ...
  useEffect(() => {
    ...
    // / Storybook / non-Electron context `window.slickDesktop` is
    ...
    const settings = window.slickDesktop?.settings
