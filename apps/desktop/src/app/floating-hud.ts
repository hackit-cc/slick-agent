...
// hairline `--stroke-sophos` paired with the soft `--shadow-sophos` float.
...
export const HUD_SURFACE =
  'rounded-xl border border-(--stroke-sophos) bg-(--ui-chat-bubble-background) shadow-sophos [-webkit-app-region:no-drag]'
