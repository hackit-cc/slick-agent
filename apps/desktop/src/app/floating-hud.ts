...
// hairline `--stroke-hackit` paired with the soft `--shadow-hackit` float.
...
export const HUD_SURFACE =
  'rounded-xl border border-(--stroke-hackit) bg-(--ui-chat-bubble-background) shadow-hackit [-webkit-app-region:no-drag]'
