import type { SlickReviewFile } from '@/global'
...
export function buildReviewFlatList(files: SlickReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: SlickReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
