...
const TAKEOVER_KEY = 'slick.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Slick can't clear via the API — the user
 *  sees exactly what runs instead of Slick silently deleting their creds. */
