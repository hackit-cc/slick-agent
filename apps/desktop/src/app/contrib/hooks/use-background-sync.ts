...
import { getLatestSessionMessages, type ProfileScope } from '@/slick'
...
interface BackgroundSyncParams {
  ...
  refreshSlickConfig: () => Promise<unknown> | unknown
...
export function useBackgroundSync({
  ...
  }, [activeSessionId, freshDraftReady, gatewayState, refreshCurrentModel, refreshSlickConfig])
}
