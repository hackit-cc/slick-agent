...
import { getSlickConfigRecord, listAllProfileSessions } from '@/slick'
...
// Slick session ids: <YYYYMMDD>_<HHMMSS>_<6 hex>. Used to offer a direct
...
function CommandPaletteBody({ onExited }: { onExited: () => void }) {
        ...
        : []),
      {
        ...
        items: [
          ...
          },
          {
            ...
            icon: Download,
            id: 'cc-update-slick',
            keywords: ['update', 'upgrade', 'slick', 'version', 'system', 'restart'],
            label: cc.updateSlick,
  ...
  const searchGroups = useMemo<PaletteGroup[]>(() => {
    ...
    // Apply a theme directly from the root search (e.g. "sophos" → Sophos). Live
