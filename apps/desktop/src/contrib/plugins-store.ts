 ...
 * `<slick home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'slick.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'slick.desktop.disabledPlugins.v1'
