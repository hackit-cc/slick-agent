...
test('generated protocol uses slick profile list, not the invalid profiles plural', () => {
  assert.match(source, /run `slick profile list` for the LIVE/)
  assert.doesNotMatch(source, /run `slick profiles list` for the LIVE/)
})
