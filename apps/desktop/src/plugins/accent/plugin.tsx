...
import type { SlickPlugin, PaletteContribution } from '@slick/plugin-sdk'
import { $accentOverride, PALETTE_AREA, setAccentOverride, STATUSBAR_AREAS } from '@slick/plugin-sdk'

import { AccentPickerTrigger } from './picker'

const plugin: SlickPlugin = {
  id: 'accent',
  name: 'Accent Picker',
  description:
