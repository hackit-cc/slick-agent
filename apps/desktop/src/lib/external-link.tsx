...
const SKIP_PROTO_RE = /^(?:file|data|mailto|javascript|blob|chrome|about|slick):/i
...
export function fetchLinkTitle(url: string): Promise<string> {
  ...
  const bridge = typeof window === 'undefined' ? undefined : window.slickDesktop?.fetchLinkTitle
...
export function openExternalLink(href: string): void {
  if (href) {
    void window.slickDesktop?.openExternal?.(href)
  }
}
 ...
 * doesn't cost a context switch out of Slick, and it is the surface the agent
