...
import type { ModelOptionsResponse, SessionInfo } from '@/types/slick'
 ...
 *
 * Only the leading status prefix (e.g. "Slick is thinking...") and the
 ...
 *  resolved comment as JSON (SlickPrComment shape); a malformed payload falls
