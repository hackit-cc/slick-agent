...
describe('displayPath', () => {
  it('collapses a macOS home prefix to ~', () => {
    expect(displayPath('/Users/brooklyn/www/slick-agent')).toBe('~/www/slick-agent')
...
describe('pathLeaf', () => {
  it('returns the last segment', () => {
    expect(pathLeaf('/Users/me/www/slick-agent')).toBe('slick-agent')
    expect(pathLeaf('~/www/slick-agent')).toBe('slick-agent')
