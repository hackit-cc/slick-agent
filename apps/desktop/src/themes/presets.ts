 ...
 *
 * The palette-bearing skins (sophos, catppuccin, everforest, solarized) are forks
 ...
 *
 *   sophos       ← github.github-vscode-theme   (Light Default / Dark Default)
 ...
 * re-derived. `sophos-alt` is first-party — do not re-derive it from GitHub.
 */
...
/**
 * Sophos — the canonical Slick desktop identity, forked from the GitHub VS Code
 ...
 *
 * `sophos` is a fork of this with its own accent, so shipping both keeps the
 * original available on its own terms instead of only existing as the thing
 * sophos diverged from. Everything but the accent family is identical between
 * them; separate presets are what let sophos's accent move without silently
...
/**
 * Sophos — the canonical Slick desktop identity: GitHub's chrome carrying Sophos
 ...
 */
export const sophosTheme: DesktopTheme = {
  name: 'sophos',
  label: 'Sophos',
  description: 'GitHub chrome, Sophos blue accent',
  colors: {
    background: '#ffffff',
    foreground: '#1f2328',
    card: '#f6f8fa',
...
const SOPHOS_ALT_BLUE = '#0053FD'
const SOPHOS_ALT_NAVY = '#1540B1'
const SOPHOS_ALT_CREAM = '#FFE6CB'

const sophosAltTint = (pct: number) => `color-mix(in srgb, ${SOPHOS_ALT_BLUE} ${pct}%, #FFFFFF)`
const sophosAltTintTransparent = (pct: number) => `color-mix(in srgb, ${SOPHOS_ALT_BLUE} ${pct}%, transparent)`

/**
 * Sophos Alt — the hand-authored Sophos from before the GitHub fork. Light is
 * glass neutrals with brand blue; dark is cream on mission-blue.
 */
export const sophosAltTheme: DesktopTheme = {
  name: 'sophos-alt',
  label: 'Sophos Alt',
  ...
  colors: {
    ...
    muted: sophosAltTint(5),
    mutedForeground: '#666678',
    popover: '#FFFFFF',
    popoverForeground: '#17171A',
    primary: SOPHOS_ALT_BLUE,
    primaryForeground: '#FCFCFC',
    secondary: sophosAltTint(7),
    secondaryForeground: '#242432',
    accent: sophosAltTint(10),
    accentForeground: '#202030',
    border: sophosAltTintTransparent(22),
    input: sophosAltTintTransparent(30),
    ring: SOPHOS_ALT_BLUE,
    midground: SOPHOS_ALT_BLUE,
    composerRing: SOPHOS_ALT_BLUE,
    destructive: '#C72E4D',
    destructiveForeground: '#FFFFFF',
    sidebarBackground: '#F3F7FF',
    sidebarBorder: sophosAltTintTransparent(18),
    userBubble: sophosAltTint(6),
    userBubbleBorder: sophosAltTintTransparent(24)
  },
  darkColors: {
    background: '#0D2F86',
    foreground: SOPHOS_ALT_CREAM,
    card: '#12378F',
    cardForeground: SOPHOS_ALT_CREAM,
    muted: '#183F9A',
    mutedForeground: '#B5C7F3',
    popover: '#123A96',
    popoverForeground: SOPHOS_ALT_CREAM,
    primary: SOPHOS_ALT_CREAM,
    primaryForeground: '#0D2F86',
    secondary: '#1B45A4',
    secondaryForeground: '#E0E8FF',
    accent: SOPHOS_ALT_NAVY,
    accentForeground: '#F0F4FF',
    border: '#3158AD',
    input: '#0B2566',
    ring: SOPHOS_ALT_CREAM,
    midground: SOPHOS_ALT_BLUE,
    composerRing: SOPHOS_ALT_CREAM,
    destructive: '#C0473A',
...
export const DEFAULT_SKIN_NAME = 'sophos'
