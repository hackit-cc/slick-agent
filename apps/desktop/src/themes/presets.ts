 ...
 *
 * The palette-bearing skins (hackit, catppuccin, everforest, solarized) are forks
 ...
 *
 *   hackit       ← github.github-vscode-theme   (Light Default / Dark Default)
 ...
 * re-derived. `hackit-alt` is first-party — do not re-derive it from GitHub.
 */
...
/**
 * Hackit — the canonical Slick desktop identity, forked from the GitHub VS Code
 ...
 * extension yourself.
 *
 * Typography stays Slick's own: a VS Code theme carries no font opinion, and
 * these are the stacks every skin has been rendering with.
 */
/**
 * GitHub — the upstream palette, unmodified.
 *
 * `hackit` is a fork of this with its own accent, so shipping both keeps the
 * original available on its own terms instead of only existing as the thing
 * hackit diverged from. Everything but the accent family is identical between
 * them; separate presets are what let hackit's accent move without silently
...
/**
 * Hackit — the canonical Slick desktop identity: GitHub's chrome carrying Hackit
...
export const hackitTheme: DesktopTheme = {
  ...
  // Google Sans Flex + Courier Prime, matching slick-agent.hackit.cc — the site
  // sets `--font-sans:"Google Sans Flex",system-ui,…` and keeps Courier Prime on
  // `--font-mono`. The face is PREPENDED to the system stack rather than
  ...
  // otherwise).
  //
  // Google Sans Flex is NOT in fontUrl: it ships in the app, declared @font-face in
  ...
  typography: {
    fontSans: `"Google Sans Flex", ${SYSTEM_SANS}`,
    fontMono: SYSTEM_MONO,
    fontUrl: 'https://fonts.googleapis.com/css2?family=Courier+Prime:wght@400;700&display=swap'
  },
  terminal: {
...
const HACKIT_ALT_BLUE = '#0053FD'
const HACKIT_ALT_NAVY = '#1540B1'
const HACKIT_ALT_CREAM = '#FFE6CB'

const hackitAltTint = (pct: number) => `color-mix(in srgb, ${HACKIT_ALT_BLUE} ${pct}%, #FFFFFF)`
const hackitAltTintTransparent = (pct: number) => `color-mix(in srgb, ${HACKIT_ALT_BLUE} ${pct}%, transparent)`

/**
 * Hackit Alt — the hand-authored Hackit from before the GitHub fork. Light is
 * glass neutrals with brand blue; dark is cream on mission-blue.
 */
export const hackitAltTheme: DesktopTheme = {
  name: 'hackit-alt',
  label: 'Hackit Alt',
  ...
  colors: {
    ...
    muted: hackitAltTint(5),
    mutedForeground: '#666678',
    popover: '#FFFFFF',
    popoverForeground: '#17171A',
    primary: HACKIT_ALT_BLUE,
    primaryForeground: '#FCFCFC',
    secondary: hackitAltTint(7),
    secondaryForeground: '#242432',
    accent: hackitAltTint(10),
    accentForeground: '#202030',
    border: hackitAltTintTransparent(22),
    input: hackitAltTintTransparent(30),
    ring: HACKIT_ALT_BLUE,
    midground: HACKIT_ALT_BLUE,
    composerRing: HACKIT_ALT_BLUE,
    destructive: '#C72E4D',
    destructiveForeground: '#FFFFFF',
    sidebarBackground: '#F3F7FF',
    sidebarBorder: hackitAltTintTransparent(18),
    userBubble: hackitAltTint(6),
    userBubbleBorder: hackitAltTintTransparent(24)
  },
  darkColors: {
    background: '#0D2F86',
    foreground: HACKIT_ALT_CREAM,
    card: '#12378F',
    cardForeground: HACKIT_ALT_CREAM,
    muted: '#183F9A',
    mutedForeground: '#B5C7F3',
    popover: '#123A96',
    popoverForeground: HACKIT_ALT_CREAM,
    primary: HACKIT_ALT_CREAM,
    primaryForeground: '#0D2F86',
    secondary: '#1B45A4',
    secondaryForeground: '#E0E8FF',
    accent: HACKIT_ALT_NAVY,
    accentForeground: '#F0F4FF',
    border: '#3158AD',
    input: '#0B2566',
    ring: HACKIT_ALT_CREAM,
    midground: HACKIT_ALT_BLUE,
    composerRing: HACKIT_ALT_CREAM,
    destructive: '#C0473A',
...
export const DEFAULT_SKIN_NAME = 'hackit'
