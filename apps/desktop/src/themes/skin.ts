/**
 * Slick skin → DesktopTheme converter.
 *
 * A "skin" is the CLI/TUI theme unit: a YAML file in `$SLICK_HOME/skins/` (or a
 * built-in) resolved by `slick_cli/skin_engine.py` and pushed to every surface
 ...
 * skin Slick authors from a prompt lights up all three surfaces from one file.
 *
...
import type { SlickSkin, SkinColors } from '@slick/shared/skin'
 ...
 */
export function skinToDesktopTheme(skin: SlickSkin): DesktopTheme | null {
