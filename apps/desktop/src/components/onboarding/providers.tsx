...
const PROVIDER_DISPLAY: Record<string, { order: number; title: string }> = {
  sophos: { order: 0, title: 'Sophos Portal' },
...
export function FeaturedProviderRow({
  ...
  return (
    <button
      ...
      type="button"
    >
      <span aria-hidden className="arc-border arc-reverse arc-sophos" />
...
/** Quick-key row for API-key providers (Fireworks leads the expanded list after Sophos, OpenRouter further down). */
