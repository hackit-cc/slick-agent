...
const PROVIDER_DISPLAY: Record<string, { order: number; title: string }> = {
  hackit: { order: 0, title: 'Hackit Portal' },
...
export function FeaturedProviderRow({
  ...
  return (
    <button
      ...
      type="button"
    >
      <span aria-hidden className="arc-border arc-reverse arc-hackit" />
...
/** Quick-key row for API-key providers (Fireworks leads the expanded list after Hackit, OpenRouter further down). */
