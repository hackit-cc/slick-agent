...
const STORAGE_KEY = 'slick.desktop.layoutTree.v2'

writeKey('slick.desktop.layoutTree.v1', null)
 ...
 */
export const $activePresetId = atom<string>(readKey('slick.desktop.layoutPreset.active') ?? 'default')

export function markActivePreset(id: string) {
  $activePresetId.set(id)
  writeKey('slick.desktop.layoutPreset.active', id)
}
 ...
 */
const DISMISSED_KEY = 'slick.desktop.dismissedPanes.v1'
...
const PANE_SHARE_KEY = 'slick.desktop.paneShare.v1'
...
const HIDDEN_STRIP_TAB_KEY = 'slick.desktop.hiddenStripTabs.v1'
...
writeKey('slick.desktop.paneDockHeals.v1', null)
...
if ((import.meta.env.DEV || import.meta.env.VITE_PERF_PROBE === '1') && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__SLICK_LAYOUT_TREE__ = {
    close: closeTreePane,
