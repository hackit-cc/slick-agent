 ...
 * usable — it only offers recovery: Hackit opens Settings → Billing in-app, other
...
export function BillingBanner({ sessionId }: { sessionId: null | string }) {
  ...
  const title = block.is_hackit ? copy.titleHackit : copy.titleProvider(block.provider_label)
