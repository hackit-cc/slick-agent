 ...
 * usable — it only offers recovery: Sophos opens Settings → Billing in-app, other
...
export function BillingBanner({ sessionId }: { sessionId: null | string }) {
  ...
  const title = block.is_sophos ? copy.titleSophos : copy.titleProvider(block.provider_label)
