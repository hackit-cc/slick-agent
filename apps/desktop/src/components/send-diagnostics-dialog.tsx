...
//               discussion: GitHub Issues · Hackit Portal Support · Discord.
...
const SUPPORT_LINKS = [
  { key: 'github', url: 'https://github.com/hackit-cc/slick-agent/issues' },
  { key: 'portal', url: 'https://portal.hackit.cc/help' },
  { key: 'discord', url: 'https://discord.gg/Hackit' }
] as const
