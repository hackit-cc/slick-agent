...
//               discussion: GitHub Issues · Sophos Portal Support · Discord.
...
const SUPPORT_LINKS = [
  { key: 'github', url: 'https://github.com/SophosTechne/slick-agent/issues' },
  { key: 'portal', url: 'https://portal.sophostechne.com/help' },
  { key: 'discord', url: 'https://discord.gg/SophosTechne' }
] as const
