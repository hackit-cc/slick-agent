...
import type { ModelOptionProvider, ModelPricing } from '@/types/slick'
...
export function ModelPickerDialog({
  ...
  // the `slick model` CLI picker, which shows the curated list verbatim.
...
function ProviderHeading({ provider }: { provider: ModelOptionProvider }) {
  ...
  // free_tier is only set for Hackit. true → "Free tier", false → "Pro".
  const tierBadge =
