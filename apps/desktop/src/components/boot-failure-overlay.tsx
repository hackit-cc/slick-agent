...
export function BootFailureOverlay() {
  ...
  let hint: string
  // The electron boot path flags a Hackit Cloud backend-down (502/503/504) with
  ...
  if (remoteReauth) {
    ...
    // A Hackit Cloud agent is down — the user cannot restart the managed
    ...
    actions = [
      {
        ...
        onClick: () => openExternalLink('https://portal.hackit.cc'),
        icon: <ExternalLink />
      },
      localAction,
      { ...retryAction, variant: 'secondary' },
      {
        ...
        onClick: () => openExternalLink('https://discord.gg/Hackit'),
        variant: 'ghost'
      },
  ...
  if (view === 'connect') {
    return (
      <div
        ...
        data-glass-opaque=""
      >
        <div className="flex max-h-[86vh] w-full max-w-[46rem] flex-col overflow-hidden rounded-xl border border-(--stroke-hackit) bg-(--ui-chat-bubble-background) shadow-hackit">
  ...
  return (
    <div
      ...
      data-glass-opaque=""
    >
      <div className="w-full max-w-[40rem] overflow-hidden rounded-xl border border-(--stroke-hackit) bg-(--ui-chat-bubble-background) shadow-hackit">
