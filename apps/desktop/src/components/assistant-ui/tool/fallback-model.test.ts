  ...
  it('shows failed title when navigate returns success=false', () => {
    const view = buildToolView(
      part({
        ...
        args: { url: 'https://slick-agent.hackit.cc/docs' },
    ...
    expect(view.title).toBe('Failed to open slick-agent.hackit.cc/docs')
  })
  ...
  it('shows opened title on success', () => {
    const view = buildToolView(
      part({
        toolName: 'browser_navigate',
        args: { url: 'https://slick-agent.hackit.cc/docs' },
        result: { success: true, url: 'https://slick-agent.hackit.cc/docs', title: 'Docs' }
      }),
      ''
    )

    expect(view.status).toBe('success')
    expect(view.title).toBe('Opened slick-agent.hackit.cc/docs')
  })
})
