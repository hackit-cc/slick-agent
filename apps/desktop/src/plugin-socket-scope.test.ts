...
// (#73044). Exercises the REAL slick + store/gateway + store/profile chain:
...
const { pluginSocket, setApiRequestConnection, setApiRequestProfile } = await import('@/slick')
...
const conn = (over: Partial<SlickConnection> = {}): SlickConnection =>
  ({
    authMode: 'oauth',
