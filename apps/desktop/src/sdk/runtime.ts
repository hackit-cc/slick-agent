 ...
 * plugins resolve `@slick/plugin-sdk` through the vite alias; RUNTIME-loaded
...
const GLOBALS = {
  __SLICK_PLUGIN_SDK__: sdk,
  __SLICK_REACT__: React,
  __SLICK_REACT_JSX__: jsxRuntime,
  __SLICK_REACT_JSX_DEV__: jsxDevRuntime
} as const
...
export function sdkImportMap(): Record<string, string> {
  cached ??= {
    '@slick/plugin-sdk': shimUrl('__SLICK_PLUGIN_SDK__'),
    'react/jsx-dev-runtime': shimUrl('__SLICK_REACT_JSX_DEV__'),
    'react/jsx-runtime': shimUrl('__SLICK_REACT_JSX__'),
    react: shimUrl('__SLICK_REACT__')
  }
