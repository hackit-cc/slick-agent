...
export default defineConfig(({ command }) => ({
  ...
  css: {
    ...
    // `C:\Users\<name>\AppData\Local\slick\slick-agent\apps\desktop`), so an
  ...
  resolve: {
    alias: {
      ...
      '@slick/plugin-sdk': path.resolve(__dirname, './src/sdk/index.ts'),
      '@slick/shared/billing': path.resolve(__dirname, '../shared/src/billing-types.ts'),
      '@slick/shared': path.resolve(__dirname, '../shared/src'),
