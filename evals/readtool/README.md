...
benchmarked ten harnesses on hostile-file handling — and whose Slick column
...
Every task runs the full Slick agent (file + terminal + search toolsets)
...
Rules of engagement (from slickbench discipline):
