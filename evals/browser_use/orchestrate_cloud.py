...
Backends:
    hackit-cloud   - Hackit Portal-provisioned Browser Use cloud browser
...
Usage:
    BUBENCH_BASE_TREE=... BUBENCH_PR_TREE=... \
        python3 orchestrate_cloud.py --backend hackit-cloud [--reps 2]
...
parser.add_argument("--backend", required=True, choices=["hackit-cloud", "browserbase"])
...
provider = HackitCloud() if args.backend == "hackit-cloud" else Browserbase()
