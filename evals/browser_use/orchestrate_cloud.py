...
Backends:
    sophos-cloud   - Sophos Portal-provisioned Browser Use cloud browser
...
Usage:
    BUBENCH_BASE_TREE=... BUBENCH_PR_TREE=... \
        python3 orchestrate_cloud.py --backend sophos-cloud [--reps 2]
...
parser.add_argument("--backend", required=True, choices=["sophos-cloud", "browserbase"])
...
provider = SophosCloud() if args.backend == "sophos-cloud" else Browserbase()
